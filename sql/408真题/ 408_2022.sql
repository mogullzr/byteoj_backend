...
环执行$i$次，因此总循环次数$T = 1 + 2 + 4 + 8 + ⋯ + 2^{k-1} = 2^{k} - 1$即$n < T < 2n$，时间复杂度为$O(n)$。', 9, 'Mogullzr', '2026-02-02 13:38:38', 9, NULL, '2026-02-02 13:38:38', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1173', '3911');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3912, '2022年408考研真题第2题', '简单', '2022年408真题', '给定有限符号集 S, in 和 out 均为 S 中所有元素的任意排列。对于初始为空的栈 ST, 下列叙述中，正确的是（ ）。
', '[''若 in 是 ST 的入栈序列，则不能判断 out 是否为其可能的出栈序列'', ''若 out 是 ST 的出栈序列，则不能判断 in 是否为其可能的入栈序列'', ''若 in 是 ST 的入栈序列，out 是对应 in 的出栈序列，则 in 与 out 一定不同'', ''若 in 是 ST 的入栈序列，out 是对应 in 的出栈序列，则 in 与 out 可能互为倒序'']', "['D']", 'D</font></strong>
参考入栈出栈序列，如果给定一个入栈序列，我们可以得到其所有可能的出栈序列，所以当给定一个出栈序列时，我们可以判断其是否正确，所以 A、B、C 均为错误选项。', 9, 'Mogullzr', '2026-02-02 13:38:38', 9, NULL, '2026-02-02 13:38:38', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1088', '3912');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3913, '2022年408考研真题第3题', '简单', '2022年408真题', '若结点 p 与 q 在二叉树 T 的中序遍历序列中相邻，且 p 在 q 之前，则下列 p 与 q 的关系中，不可能的是（ ）。
I. q 是 p 的双亲
II. q 是 p 的右孩子
III. q 是 p 的右兄弟
IV. q 是 p 的双亲的双亲
', '[''仅 I'', ''仅 III'', ''仅 II、III'', ''仅 II、IV'']', "['B']", 'B</font></strong>
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/58e0518b518841db80da6c3ec99d2049.svg)
', 9, 'Mogullzr', '2026-02-02 13:38:38', 9, NULL, '2026-02-02 13:38:38', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1243', '3913');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3914, '2022年408考研真题第4题', '简单', '2022年408真题', '若三叉树 T 中有 244 个结点（叶结点的高度为 1），则 T 的高度至少是 ( )。
', '[''8'', ''7'', ''6'', ''5'']', "['C']", 'C</font></strong>
高度为$n$的二叉树最多有$1 + 2 + ⋯ + 2^{n-1} = 2^{n} - 1$个结点，高度为$n$的三叉树最多有$f(n) = 1 + 3 + ⋯ + 3^{n-1} = \\frac{3^{n}-1}{3-1} - \\frac{3^{n}-1}{2}$。$f(5) = 121$$f(6) = 364$因为$121 < 244 < 364$，所以高度至少为 6。', 9, 'Mogullzr', '2026-02-02 13:38:39', 9, NULL, '2026-02-02 13:38:39', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1144', '3914');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3915, '2022年408考研真题第5题', '简单', '2022年408真题', '对任意给定的含 n (n > 2) 个字符的有限集 S, 用二叉树表示 S 的哈夫曼编码集和定长编码集，分别得到二叉树 T1 和 T2。下列叙述中，正确的是 ( )。
', '[''T1 与 T2 的结点数相同'', ''T1 的高度大于 T2 的高度'', ''出现频次不同的字符在 T1 中处于不同的层'', ''出现频次不同的字符在 T2 中处于相同的层'']', "['D']", 'D</font></strong>
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/b994da6e218a4b888eea1f56b97ac4a8.svg)
', 9, 'Mogullzr', '2026-02-02 13:38:40', 9, NULL, '2026-02-02 13:38:40', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1145', '3915');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3916, '2022年408考研真题第6题', '简单', '2022年408真题', '对于无向图 G=(V,E)，下列选项中，正确的是（  ）。
', '[''当 |V| ＞|E| 时，G 一定是连通的'', ''当 |V| < |E| 时，G 一定是连通的'', ''当 |V| = |E|-1 时，G 一定是不连通的'', ''当 |V| > |E|+1 时，G 一定是不连通的'']', "['D']", 'D</font></strong>
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/7d0db44569214504a2e7f92c82365254.svg)
', 9, 'Mogullzr', '2026-02-02 13:38:41', 9, NULL, '2026-02-02 13:38:41', 1, 1);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/88e2ce9e5e35419eab3f4ae3369e6603.svg)
...
- j 的时间余量 = vl(6) - ve(5) - 1 = 12 - 9 - 1 = 2，时间余量最大的活动是 g。', 9, 'Mogullzr', '2026-02-02 13:38:43', 9, NULL, '2026-02-02 13:38:43', 1, 1);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/187ebd9ad4bd4be99fb162d13da80d1e.svg)

', '[''60，90，280'', ''60，90，350'', ''60，85，110，350'', ''60，90，110，350'']', "['D']", 'D</font></strong>
参考B 树插入操作，在 5 阶 B 树中，除根结点外的非叶子结点的关键字数 k 需要满足 2 ≤ k ≤ 4。当被删关键字 x 不在终端结点（最底层非叶子结点）时，可以用 x 的前驱（或后继) 关键字 y 来替代 x，然后在相应结点中删除 y。情况①：删除 260，将其前驱 110 放入 260 处，删除 110 后的结点 不满足 5 阶 B 树定义，从左兄弟中借 85，将 85 放入根中，将根中的 90 移入结点 变为 <90, 100>。情况②：删除 260，将其后继 280 放入 260 处，结点 不满足 5 阶 B 树定义且左右兄弟都不够借，结点 可以和左兄弟 <100, 110> 以及关键字 280 合并成一个新的结点 <100, 110, 280, 300>。情况③：在情况②中，结点 也可以和右兄弟 <400, 500> 以及关键字 350 合并成一个新的结点 <300, 350, 400, 500>。综上，T1 根结点中的关键字序列可能是 <60, 85, 110, 350> 或 <60, 90, 350> 或 <60, 90, 280>，仅 D 不可能。', 9, 'Mogullzr', '2026-02-02 13:38:45', 9, NULL, '2026-02-02 13:38:45', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1094', '3918');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3919, '2022年408考研真题第9题', '简单', '2022年408真题', '下列因素中，影响散列（哈希）方法平均查找长度的是（ ）。
I. 装填因子
II. 散列函数
III. 冲突解决策略
', '[''仅 I、II'', ''仅 I、III'', ''仅 II、III'', ''I、 II、 III'']', "['D']", 'D</font></strong>
三者都会影响：装填因子越大，说明哈希表中存储的元素越满，发生冲突的可能性越大，平均查找长度也越大。散列函数、突解决策略会影响发生冲突的可能性。', 9, 'Mogullzr', '2026-02-02 13:38:45', 9, NULL, '2026-02-02 13:38:45', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1165', '3919');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3920, '2022年408考研真题第10题', '简单', '2022年408真题', '使用二路归并排序对含 n 个元素的数组 M 进行排序时，二路归并操作的功能是（ ）。
', '[''将两个有序表合并为一个新的有序表'', ''将 M 划分为两部分，两部分的元素个数大致相等'', ''将 M 划分为 n 个部分，每个部分中仅含有一个元素'', ''将 M 划分为两部分，一部分元素的值均小于另一部分元素的值'']', "['A']", 'A</font></strong>
概念题，归并针对的对象是序列，二路归并就是将两个有序序列合并成一个。', 9, 'Mogullzr', '2026-02-02 13:38:45', 9, NULL, '2026-02-02 13:38:45', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1195', '3920');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3921, '2022年408考研真题第11题', '简单', '2022年408真题', '对数据进行排序时，若采用直接插入排序而不采用快速排序，则可能的原因是（  ）。
I. 大部分元素已有序
II. 待排序元素数量很少
III. 要求空间复杂度为 O(1)
IV. 要求排序算法是稳定的
', '[''仅 I、II'', ''仅 III、IV'', ''仅 I、II、IV'', ''I、 II、 III、 IV'']', "['D']", 'D</font></strong>
直接插入排序和快速排序的特点如下表所示：
...
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3922, '2022年408考研真题第12题', '简单', '2022年408真题', '某计算机主频为 1GHz，程序 P 运行过程中，共执行了 10000 条指令，其中，80% 的指令执行平均需 1 个时钟周期，20% 的指令执行平均需 10 个时钟周期。程序 P 的平均 CPI 和 CPU 执行时间分别是（ ）。
', '[''2.8，28μs'', ''28，28μs'', ''2.8，28ms'', ''28，28ms'']', "['A']", 'A</font></strong>
...
CPU 执行时间=$(10000 × 2.8)/10^{9} = 2.8 × 10^{−5}s = 28μs$。', 9, 'Mogullzr', '2026-02-02 13:38:45', 9, NULL, '2026-02-02 13:38:45', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1131', '3922');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3923, '2022年408考研真题第13题', '简单', '2022年408真题', '32 位补码所能表示的整数范围是（ ）。
', '[''$−2^{32} ∼ 2^{31} - 1$'', ''$−2^{31} ∼ 2^{31} - 1$'', ''$−2^{32} ∼ 2^{32} - 1$'', ''$−2^{31} ∼ 2^{32} - 1$'']', "['B']", 'B</font></strong>
32 位补码的最大值为 0x7fffffff =$2^{31} - 1$（最高位为 0，其他位为 1），最小值为 0x80000000 =$−2^{31}$（最高位为 1，其他位为 0)。', 9, 'Mogullzr', '2026-02-02 13:38:45', 9, NULL, '2026-02-02 13:38:45', 1, 1);
...
1011111011100000000000000000000，对应的十六进制格式为 BEE00000H。', 9, 'Mogullzr', '2026-02-02 13:38:45', 9, NULL, '2026-02-02 13:38:45', 1, 1);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/44e6ba87859f4624ba6b995bf875d169.svg)
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/30e72b4a7adc4e23a9c1b6d2f841c663.svg)
...
Cache 行数 8，比较器的位数就是 Tag 标记位数 20。', 9, 'Mogullzr', '2026-02-02 13:38:47', 9, NULL, '2026-02-02 13:38:47', 1, 1);
...
- 芯片内行数是 8192，一行的大小是 8192×8bit，行缓冲长度就是一行的大小，<strong><font color=''#2656b3''><strong><font color=''#2656b3''>D 正确</font></strong></font></strong>。', 9, 'Mogullzr', '2026-02-02 13:38:48', 9, NULL, '2026-02-02 13:38:48', 1, 1);
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3928, '2022年408考研真题第18题', '简单', '2022年408真题', '下列选项中，属于指令集体系结构（ISA）规定的内容是（ ）。
Ⅰ. 指令字格式和指令类型
Ⅱ. CPU 的时钟周期
Ⅲ. 通用寄存器个数和位数
Ⅳ. 加法器的进位方式
', '[''仅Ⅰ、Ⅱ'', ''仅Ⅰ、Ⅲ'', ''仅Ⅱ、Ⅳ'', ''仅Ⅰ、Ⅲ、Ⅳ'']', "['B']", 'B</font></strong>
指令集处于软硬件的交界面上。指令字和指令格式、通用寄存器个数和位数都与
机器指令有关，由指令体系结构规定。两个 CPU 可以有不同的时钟周期，但指令集可以相同，CPU 的
时钟周期不由 ISA 规定。加法器的进位方式涉及电路设计，也不由指令集规定。', 9, 'Mogullzr', '2026-02-02 13:38:48', 9, NULL, '2026-02-02 13:38:48', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1280', '3928');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3929, '2022年408考研真题第19题', '简单', '2022年408真题', '设计某指令系统时，假设采用 16 位定长指令字格式，操作码使用扩展编码方式，地址码为 6 位，包含零地址、一地址和二地址 3 种格式的指令。若二地址指令有 12 条，一地址指令有 254 条，则零地址指令的条数最多为（ ）。
', '[''0'', ''2'', ''64'', ''128'']', "['D']", 'D</font></strong>
本题考察N 地址指令如下图所示：零地址指令的 OP 字段位数相比一地址和二地址指令更短，但是需要注意的是，零地址指令的 OP 字段前缀与一地址和二地址指令的 OP 字段不能相同。
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/8385324198bf4ab48175c64677ba5d2a.svg)
所以零地址指令的条数为$2^{16} - 254 × 2^{6} - 12 × 2^{12} = 128$。', 9, 'Mogullzr', '2026-02-02 13:38:48', 9, NULL, '2026-02-02 13:38:48', 1, 1);
...
将源程序转换为可执行目标文件的过程分为预处理、编译、汇编、链接四个阶段', 9, 'Mogullzr', '2026-02-02 13:38:50', 9, NULL, '2026-02-02 13:38:50', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1317', '3930');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3931, '2022年408考研真题第21题', '简单', '2022年408真题', '下列关于中断 I/O 方式的叙述中，不正确的是（ ）。
', '[''适用于键盘、针式打印机等字符型设备'', ''外设和主机之间的数据传送通过软件完成'', ''外设准备数据的时间应小于中断处理时间'', ''外设为某进程准备数据时 CPU 可运行其他进程'']', "['C']", 'C</font></strong>
...
时，可令该进程阻塞，CPU 运行其他进程，D 正确。', 9, 'Mogullzr', '2026-02-02 13:38:50', 9, NULL, '2026-02-02 13:38:50', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1132', '3931');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3932, '2022年408考研真题第22题', '简单', '2022年408真题', '下列关于并行处理技术的叙述中，不正确的是（ ）。
', '[''多核处理器属于 MIMD 结构'', ''向量处理器属于 SIMD 结构'', ''硬件多线程技术只可用于多核处理器'', ''SMP 中所有处理器共享单一物理地址空间'']', "['C']", 'C</font></strong>
本题考察多处理器，
...
过存取指令来访问同一片主存地址空间，D 正确。', 9, 'Mogullzr', '2026-02-02 13:38:50', 9, NULL, '2026-02-02 13:38:50', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1318', '3932');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3933, '2022年408考研真题第23题', '简单', '2022年408真题', '下列关于多道程序系统的叙述中，不正确的是（ ）。
', '[''支持进程的并发执行'', ''不必支持虚拟存储管理'', ''需要实现对共享资源的管理'', ''进程数越多 CPU 利用率越高'']', "['D']", 'D</font></strong>
操作系统的基本特点：并发、共享、虚拟、异步，其中最基本、一定要实现的是并发和共享，A、C 正确。早期的多道批处理操作系统会将所有进程的数据全部调入主存，再让多道程序并发执行，即使不支持虚拟存储管理，也能实现“多道程序并发”，B 正确。进程多并不意味着 CPU 利用率高，进程数量越多，进程之间的资源竞争越激烈，甚至可能因为资源竞争而出现死锁现象，导致 CPU 利用率低，D 错误。', 9, 'Mogullzr', '2026-02-02 13:38:50', 9, NULL, '2026-02-02 13:38:50', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1110', '3933');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3934, '2022年408考研真题第24题', '简单', '2022年408真题', '下列选项中，需要在操作系统进行初始化过程中创建的是（ ）。
', '[''中断向量表'', ''文件系统的根目录'', ''硬盘分区表'', ''文件系统的索引节点表'']', "['A']", 'A</font></strong>
...
- 文件系统的索引节点表：索引节点表（inode 表）是在文件系统创建时生成的，不是操作系统初始化的一部分。因此，正确答案是 A。', 9, 'Mogullzr', '2026-02-02 13:38:50', 9, NULL, '2026-02-02 13:38:50', 1, 1);
...
- 190ms 时 P2 执行完毕，结束；总共调度 6 次。', 9, 'Mogullzr', '2026-02-02 13:38:50', 9, NULL, '2026-02-02 13:38:50', 1, 1);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/73355d5b92c94e5f8dc9291978171bef.svg)
...
所以安全序列可以是 ①P0、P1、P2 或 ②P0、P2、P1。', 9, 'Mogullzr', '2026-02-02 13:38:52', 9, NULL, '2026-02-02 13:38:52', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1185', '3936');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3937, '2022年408考研真题第27题', '简单', '2022年408真题', '下列关于 CPU 模式的叙述中，正确的是（ ）。
', '[''CPU 处于用户态时只能执行特权指令'', ''CPU 处于内核态时只能执行特权指令'', ''CPU 处于用户态时只能执行非特权指令'', ''CPU 处于内核态时只能执行非特权指令'']', "['C']", 'C</font></strong>
CPU 在用户态时只能执行非特权指令，在内核态时可以执行特权指令和非特权指令。', 9, 'Mogullzr', '2026-02-02 13:38:52', 9, NULL, '2026-02-02 13:38:52', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1182', '3937');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3938, '2022年408考研真题第28题', '简单', '2022年408真题', '下列事件或操作中，可能导致进程 P 由执行态变为阻塞态的是（ ）。
Ⅰ. 进程 P 读文件
Ⅱ. 进程 P 的时间片用完
Ⅲ. 进程 P 申请外设
Ⅳ. 进程 P 执行信号量的 wait() 操作
', '[''仅Ⅰ、Ⅳ'', ''仅Ⅱ、Ⅲ'', ''仅Ⅲ、Ⅳ'', ''仅Ⅰ、Ⅲ、Ⅳ'']', "['D']", 'D</font></strong>
参考状态转化。
...
0，则进程进入阻塞态，等待其他进程用 signal() 操作唤醒，V 正确。', 9, 'Mogullzr', '2026-02-02 13:38:52', 9, NULL, '2026-02-02 13:38:52', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1206', '3938');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3939, '2022年408考研真题第29题', '简单', '2022年408真题', '某进程访问的页 b 不在内存中，导致产生缺页异常，该缺页异常处理过程中不一定包含的操作是（ ）。
', '[''淘汰内存中的页'', ''建立页号与页框号的对应关系'', ''将页 b 从外存读入内存'', ''修改页表中页 b 对应的存在位'']', "['A']", 'A</font></strong>
缺页异常需要从磁盘调页到内存中，将新调入的页与页框建立对应关系，并修改
该页的存在位，B、C、D 正确：如果内存中有空闲页框，就不需要淘汰其他页，A 错误。', 9, 'Mogullzr', '2026-02-02 13:38:52', 9, NULL, '2026-02-02 13:38:52', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1186', '3939');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3940, '2022年408考研真题第30题', '简单', '2022年408真题', '下列选项中，不会影响系统缺页率的是（ ）。
', '[''页面置换算法'', ''工作集的大小'', ''进程的数量'', ''页缓冲队列的长度'']', "['D']", 'D</font></strong>
...
回磁盘，队列长度会影响页面置换的速度，但不会影响缺页率，答案选 D。', 9, 'Mogullzr', '2026-02-02 13:38:52', 9, NULL, '2026-02-02 13:38:52', 1, 1);
...
Ⅲ. 执行系统调用服务程序
Ⅳ. 将 CPU 模式改为内核态
', '[''仅Ⅰ、Ⅲ'', ''仅Ⅱ、Ⅲ'', ''仅Ⅱ、Ⅳ'', ''仅Ⅱ、Ⅲ、Ⅳ'']', "['B']", 'B</font></strong>
...
这一点不是由操作系统主动完成，而是由硬件自动完成的：当执行陷阱指令（如`int 0x80`）或发生中断时，CPU 自动将模式从用户态切换为内核态，然后跳转到操作系统提供的中断向量地址。所以，这属于硬件响应的一部分，不是由操作系统“显式”控制的。所以正确答案选择 B。', 9, 'Mogullzr', '2026-02-02 13:38:52', 9, NULL, '2026-02-02 13:38:52', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1205', '3941');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3942, '2022年408考研真题第32题', '简单', '2022年408真题', '下列关于驱动程序的叙述中，不正确的是（ ）。
', '[''驱动程序与 I/O 控制方式无关'', ''初始化设备是由驱动程序控制完成的'', ''进程在执行驱动程序时可能进入阻塞态'', ''读/写设备的操作是由驱动程序控制完成的'']', "['A']", 'A</font></strong>
...
设备控制器的内部实现，因此也只有厂家提供的驱动程序能控制设备的读/写操作，D 正确。厂家会根据设备特性，在驱动程序中实现一种合适的 I/O 控制方式，A 错误。', 9, 'Mogullzr', '2026-02-02 13:38:52', 9, NULL, '2026-02-02 13:38:52', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1184', '3942');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3943, '2022年408考研真题第33题', '简单', '2022年408真题', '在 ISO/OSI 参考模型中，实现两个相邻结点间流量控制功能的是（ ）。
', '[''物理层'', ''数据链路层'', ''网络层'', ''传输层'']', "['B']", 'B</font></strong>
在ISO/OSI 模型中，数据链路层、网络层、传输层都具有流量控制功能，数据链路层是相邻结点之间的流量控制，网络层是整个网络中的流量控制，传输层是端到端的流量控制。', 9, 'Mogullzr', '2026-02-02 13:38:52', 9, NULL, '2026-02-02 13:38:52', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1120', '3943');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3944, '2022年408考研真题第34题', '简单', '2022年408真题', '在一条带宽为 200kHz 的无噪声信道上，若采用 4 个幅值的 ASK 调制，则该信道的最大数据传输速率是（ ）。
', '[''200 kbps'', ''400 kbps'', ''800 kbps'', ''1600 kbps'']', "['C']", 'C</font></strong>
根据奈奎斯特定理，最大数据传输速率=$2Wlog_{2}V$，4 个幅值的 ASK 调制说明有 4 个相位，将 V=4 代入，得 800kbps。', 9, 'Mogullzr', '2026-02-02 13:38:53', 9, NULL, '2026-02-02 13:38:53', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1286', '3944');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3945, '2022年408考研真题第35题', '简单', '2022年408真题', '若某主机的 IP 地址是 183.80.72.48, 子网掩码是 255.255.192.0, 则该主机所在网络的网络地址是 (  )。
', '[''183.80.0.0'', ''183.80.64.0'', ''183.80.72.0'', ''183.80.192.0'']', "['B']", 'B</font></strong>
主机所在网络的网络地址可以通过主机的 IP 地址和子网掩码逐位相与得到。子网掩码 255.255.192.0 的二进制前 18 位为 1、后 14 位为 0，把主机 P 地址的后 14 位变为 0，得
到的结果为 183.80.64.0，即为主机所在网络的网络地址。', 9, 'Mogullzr', '2026-02-02 13:38:53', 9, NULL, '2026-02-02 13:38:53', 1, 1);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/63d1079b018d4ef295d15969c0046b75.svg)
...
而该主机的子网掩码和网关的子网掩码也相同，/27 即为 255.255.255.224。', 9, 'Mogullzr', '2026-02-02 13:38:54', 9, NULL, '2026-02-02 13:38:54', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1257', '3946');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3947, '2022年408考研真题第37题', '简单', '2022年408真题', '在 SDN 网络体系结构中，SDN 控制器向数据平面的 SDN 交换机下发流表时所使用的接口是（ ）。
', '[''东向接口'', ''南向接口'', ''西向接口'', ''北向接口'']', "['B']", 'B</font></strong>
SDN对上层开发者提供的编程接口称为北向接口，而南向接口则负责控制平面和
数据平面间的通信，所以 SDN 控制器向数据平面的 SDN 交换机下发流表时使用南向接口。', 9, 'Mogullzr', '2026-02-02 13:38:54', 9, NULL, '2026-02-02 13:38:54', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1319', '3947');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3948, '2022年408考研真题第38题', '简单', '2022年408真题', '假设主机甲和主机乙已建立一个 TCP 连接，最大段长 MSS = 1 KB，甲一直有数据向乙发送，当甲的拥塞窗口为 16KB 时，计时器发生了超时，则甲的拥塞窗口再次增长到 16KB 所需要的时间至少是（ ）。
', '[''4 RTT'', ''5 RTT'', ''11 RTT'', ''16 RTT'']', "['C']", 'C</font></strong>
...
', '[''30ms'', ''40ms'', ''50ms'', ''60ms'']', "['B']", 'B</font></strong>
...
像文件，完成传输，总共需要 4 个 RTT，即 40ms。', 9, 'Mogullzr', '2026-02-02 13:38:54', 9, NULL, '2026-02-02 13:38:54', 1, 1);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/c683b76204634430a0feb039be9b60b3.svg)

T1 的存储结果如下：

![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/9f6addc2be2b47f1923c11588556fcba.svg)

T2 的存储结果如下：

![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/f5f6442e6ab84608a117153c69e3aaf6.svg)
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/31fc42ab85c84b279093b19c089b5dae.svg)
...
到控制部件的输入端。
', 9, 'Mogullzr', '2026-02-02 13:39:00', 9, NULL, '2026-02-02 13:39:00', 1, 0);
...
', '[]', '', '1）参考CHS 地址，三个字段的名称为柱面号（或磁道号）、磁头号（或盘面号）、扇区号。
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/afde8d8f5f1346abbe50943bdba3cd6a.svg)
...
用三级间接地址项）。
', 9, 'Mogullzr', '2026-02-02 13:39:01', 9, NULL, '2026-02-02 13:39:01', 1, 0);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/b5d18090fd0a43329dfc8377c822048c.svg)
...
```
', 9, 'Mogullzr', '2026-02-02 13:39:03', 9, NULL, '2026-02-02 13:39:03', 1, 0);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/109db4b1f964493d9827e9e54bf3b25a.svg)
...
地址 3 是发送端的地址。
', 9, 'Mogullzr', '2026-02-02 13:39:04', 9, NULL, '2026-02-02 13:39:04', 1, 0);
