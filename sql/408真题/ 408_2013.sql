INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3488, '2013年408考研真题第1题', '简单', '2013年408真题', '已知两个长度分别为 m 和 n 的升序链表，若将它们合并为一个长度为 m+n 的降序链表，则最坏情况下的时间复杂度是（）。', '[''$O(n)$'', ''$O(m × n)$'', ''$O(min(m, n))$'', ''$O(max(m, n))$'']', "['D']", 'D</font></strong>
两个升序链表合并，两两比较表中元素，每比较一次确定一个元素的链接位置（取较小元素，头插法）。当一个链表比较结束后，将另一个链表的剩余元素插入即可。最坏的情况是两个链表中的元素依次进行比较，直到两个链表都到表尾，即每个元素都经过比较，时间复杂度为$O(m + n) = O(max(m, n))$。', 9, 'Mogullzr', '2026-02-01 23:08:36', 9, NULL, '2026-02-01 23:08:36', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1173', '3488');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3489, '2013年408考研真题第2题', '简单', '2013年408真题', '一个栈的入栈序列为$1, 2, 3, ⋯  , n$，其出栈序列是$p_{1}, p_{2}, p_{3}, ⋯  , p_{n}$，若$p_{2} = 3$，则$p_{3}$可能取值的个数是（）。', '[''$n - 3$'', ''$n - 2$'', ''$n - 1$'', ''无法确定'']', "['C']", 'C</font></strong>
本题考察入栈出栈序列。显然，$3$之后的$4, 5, ⋯  , n$都是$p_{3}$可取的数（一直进栈直到该数入栈后马上出栈）。接下来分析 1 和 2：$p_{1}$只能是$3$之前入栈的数（可能是 1 或 2），当$p_{1} = 1$时，$p_{3}$可取$2$；当$p_{1} = 2$时，$p_{3}$可取$1$，故$p_{3}$可能取除$3$之外的所有数，个数为$n - 1$。', 9, 'Mogullzr', '2026-02-01 23:08:36', 9, NULL, '2026-02-01 23:08:36', 1, 1);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/ab8006975aea4f41b4db424e4b46bad9.svg)
', 9, 'Mogullzr', '2026-02-01 23:08:36', 9, NULL, '2026-02-01 23:08:36', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1090', '3490');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3491, '2013年408考研真题第4题', '简单', '2013年408真题', '已知三叉树 T 中 6 个叶结点的权分别是 2，3，4，5，6，7，T 的带权（外部）路径长度最小是（ ）。', '[''27'', ''46'', ''54'', ''56'']', "['B']", 'B</font></strong>
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/eaaa06a81692458cbf618b670ad37fc9.svg)
最小的带权路径长度为$(2 + 3) × 3 + (4 + 5) × 2 + (6 + 7) × 1 = 46$。', 9, 'Mogullzr', '2026-02-01 23:08:37', 9, NULL, '2026-02-01 23:08:37', 1, 1);
...
邻接矩阵A 为非对称矩阵，说明图是有向图，度为入度加出度之和。各顶点的度是矩阵中此结点对应的行（对应出度）和列（对应入度）的非零元素之和。', 9, 'Mogullzr', '2026-02-01 23:08:39', 9, NULL, '2026-02-01 23:08:39', 1, 1);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/1863b3e31a104518998f85398e71a54b.svg)
', '[''h，c，a，b，d，e，g，f'', ''e，a，f，g，b，h，c，d'', ''d，b，c，a，h，e，f，g'', ''a，b，c，d，h，e，f，g'']', "['D']", 'D</font></strong>
此题为送分题。只要掌握DFS和BFS的遍历过程，便能轻易解决。逐个代入，手工模拟，选项 D 是深度优先遍历，而不是广度优先遍历。', 9, 'Mogullzr', '2026-02-01 23:08:40', 9, NULL, '2026-02-01 23:08:40', 1, 1);
...
基准程序的 CPI= 2x0.5 + 3x0.2 + 4x0.1 + 5x0.2 = 3。计算机的主频为 1.2 GHz, 即 1200 MHz，故该机器的MIPS= 1200/3= 400。', 9, 'Mogullzr', '2026-02-01 23:08:44', 9, NULL, '2026-02-01 23:08:44', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1175', '3499');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3500, '2013年408考研真题第13题', '简单', '2013年408真题', '某数采用 IEEE754 单精度浮点数格式表示为 C6400000H，则该数的值是（ ）。', '[''$−1.5 × 2^{13}$'', ''$−1.5 × 2^{12}$'', ''$−0.5 × 2^{13}$'', ''$−0.5 × 2^{12}$'']', "['A']", 'A</font></strong>
IEEE 754单精度浮点数格式为 C640 OOOOH, 二进制格式为 1100 0110 0100 0000 0000 0000 0000 0000, 转换为标准的格式为：`| 1（符号位） | 1000 1100（阶码） | 100 0000 0000 0000 0000 0000（尾数） |`数符 = 1 表示负数；阶码值为 1000 1100 - 0111 1111 = 0000 1101 = 13; 尾数值为 1.5（注意其有隐含位，要加 1)。因此，浮点数的值为$−1, 5 × 2^{13}$。', 9, 'Mogullzr', '2026-02-01 23:08:44', 9, NULL, '2026-02-01 23:08:44', 1, 1);
...
x*2，将 x 算术左移一位为 1 1101000；y/2，将 y 算术右移一位为 1 1011000, 均无溢出或丢失精度。补码相加为 1 1101000 + 1 1011000 = 1 1000000, 亦无溢出。', 9, 'Mogullzr', '2026-02-01 23:08:44', 9, NULL, '2026-02-01 23:08:44', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1099', '3501');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3502, '2013年408考研真题第15题', '简单', '2013年408真题', '用海明码对长度为 8 位的数据进行检/纠错时，若能纠正一位错，则校验位数至少为（ ）。', '[''2'', ''3'', ''4'', ''5'']', "['C']", 'C</font></strong>
设校验位的位数为 k，数据位的位数为 n，海明码能纠正一位错应满足下述关系：$2^{k} ≥ n + k + 1$。n = 8，当 k = 4 时，$2^{4}(= 16) > 8 + 4 + 1(= 13)$，符合要求，故校验位至少是 4 位。', 9, 'Mogullzr', '2026-02-01 23:08:44', 9, NULL, '2026-02-01 23:08:44', 1, 1);
...
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3503, '2013年408考研真题第16题', '简单', '2013年408真题', '某计算机主存地址空间大小为 256MB，按字节编址。虚拟地址空间大小为 4GB，采用页式存储管理，页面大小为 4KB，TLB（快表）采用全相联映射，有 4 个页表项，内容如下表所示。则对虚拟地址 03FFF180H 进行虚实地址变换的结果是（ ）。', '[''0153180H'', ''0035180H'', ''TLB 缺失'', ''缺页'']', "['A']", 'A</font></strong>
按字节编址，页面大小为 4KB，页内地址共 12 位。地址空间大小为 4GB，虚拟地址共 32 位，前 20 位为页号。虚拟地址为 03FF F180H，故页号为 03 FFFH，页内地址为 180H。查找页标记 03FFFH 所对应的页表项，页框号为 0153H，页框号与页内地址拼接即为物理地址 0153180H。', 9, 'Mogullzr', '2026-02-01 23:08:44', 9, NULL, '2026-02-01 23:08:44', 1, 1);
...
根据变址寻址的方法，变址寄存器的内容（1000H）与形式地址的内容（2000H）相加，得到操作数的实际地址（3000H）, 根据实际地址访问内存，获取操作数 4000H。', 9, 'Mogullzr', '2026-02-01 23:08:44', 9, NULL, '2026-02-01 23:08:44', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1103', '3504');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3505, '2013年408考研真题第18题', '简单', '2013年408真题', '某 CPU 主频为 1.03GHz，采用 4 级指令流水线，每个段的执行需要 1 个时钟周期。假定 CPU 执行了 100 条指令，在其执行过程中没有发生任何流水线阻塞，此时流水线的吞吐率为（ ）。', '[''$0.25 × 10^{9}$条指令/秒'', ''$0.97 × 10^{9}$条指令/秒'', ''$1.0 × 10^{9}$条指令/秒'', ''$1.03 × 10^{9}$条指令/秒'']', "['C']", 'C</font></strong>
采用 4 级流水执行 100 条指令，在执行过程中共用 4 + (100-1) =103 个时钟周期。CPU 的主频是 1.03GHz，也就是说每秒钟有 1.03G 个时钟周期。流水线的吞吐率为$1.03G × 100/103 = 1.0x10^{9}$条指令／秒。', 9, 'Mogullzr', '2026-02-01 23:08:44', 9, NULL, '2026-02-01 23:08:44', 1, 1);
...
因此，正确答案是：<strong><font color=''#2656b3''>B. USB</font></strong>。', 9, 'Mogullzr', '2026-02-01 23:08:44', 9, NULL, '2026-02-01 23:08:44', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1152', '3506');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3507, '2013年408考研真题第20题', '简单', '2013年408真题', '下列选项中，用于提高 RAID 可靠性的措施有（ ）。I. 磁盘镜像Ⅱ. 条带化Ⅲ. 奇偶校验Ⅳ. 增加 Cache 机制', '[''仅 I、Ⅱ'', ''仅 I、Ⅲ'', ''仅 I、Ⅲ和Ⅳ'', ''仅Ⅱ、Ⅲ和Ⅳ'']', "['B']", 'B</font></strong>
本题考察RAID，RAID0 方案是无几余和无校验的磁盘阵列，而 RAID1~5 方案均是加入了冗余（镜像）或校验的磁盘阵列。条带化技术就是一种自动地将 IO 的负载均衡到多个物理磁盘上的技术，条带化技术就是将一块连续的数据分成很多小部分并把它们分别存储到不同磁盘上去。这就能使多个进程同时访问数据的多个不同部分但不会造成磁盘冲突，而且在需要对这种数据进行顺序访问的时候可以获得最大程度上的 I/0 并行能力，从而获得非常好的性能。故能够提高 RAID 可靠性的措施主要是对磁盘进行镜像处理和奇偶校验，其余选项不符合条件。', 9, 'Mogullzr', '2026-02-01 23:08:44', 9, NULL, '2026-02-01 23:08:44', 1, 1);
...
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3510, '2013年408考研真题第23题', '简单', '2013年408真题', '用户在删除某文件的过程中，操作系统不可能执行的操作是（ ）。', '[''删除此文件所在的目录'', ''删除与此文件关联的目录项'', ''删除与此文件对应的文件控制块'', ''释放与此文件关联的内存缓冲区'']', "['A']", 'A</font></strong>
此文件所在目录下可能还存在其他文件，因此删除文件时不能（也不需要）删除文件所在的目录，而与此文件关联的目录项和文件控制块需要随着文件一同删除，同时释放文件关联的内存缓冲区。', 9, 'Mogullzr', '2026-02-01 23:08:45', 9, NULL, '2026-02-01 23:08:45', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1220', '3510');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3511, '2013年408考研真题第24题', '简单', '2013年408真题', '为支持 CD-ROM 中视频文件的快速随机播放，播放性能最好的文件数据块组织方式是（ ）。', '[''连续结构'', ''链式结构'', ''直接索引结构'', ''多级索引结构'']', "['A']", 'A</font></strong>
为了实现快速随机播放，要保证最短的查询时间，即不能选取链表和索引结构，因此连续分配方案最优。', 9, 'Mogullzr', '2026-02-01 23:08:45', 9, NULL, '2026-02-01 23:08:45', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1115', '3511');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3512, '2013年408考研真题第25题', '简单', '2013年408真题', '用户程序发出磁盘 I/O 请求后，系统的处理流程是：用户程序→系统调用处理程序→设备驱动程序→中断处理程序。其中，计算数据所在磁盘的柱面号、磁头号、扇区号的程序是（ ）。', '[''用户程序'', ''系统调用处理程序'', ''设备驱动程序'', ''中断处理程序'']', "['C']", 'C</font></strong>
计算磁盘号、磁头号和扇区号的工作是由设备驱动程序完成的。题中的功能因设备硬件的不同而不同，因此应由厂家提供的设备驱动程序实现。', 9, 'Mogullzr', '2026-02-01 23:08:45', 9, NULL, '2026-02-01 23:08:45', 1, 1);
...
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3513, '2013年408考研真题第26题', '简单', '2013年408真题', '若某文件系统索引结点 (inode) 中有直接地址项和间接地址项，则下列选项中，与单个文件长度无关的因素是（ ）。', '[''索引结点的总数'', ''间接地址索引的级数'', ''地址项的个数'', ''文件块大小'']', "['A']", 'A</font></strong>
四个选项中，只有 A 选项是与单个文件长度无关的。索引结点的总数即文件的总数，与单个文件的长度无关；间接地址级数越多、地址项数越多、文件块越大，单个文件的长度就会越大。', 9, 'Mogullzr', '2026-02-01 23:08:45', 9, NULL, '2026-02-01 23:08:45', 1, 1);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/606620f4b8a046b4b08fb2317419faa8.svg)
进程从外设读入并分析 2 个数据块的最短时间是（ ）。', '[''200'', ''295'', ''300'', ''390'']', "['C']", 'C</font></strong>
在单缓冲中，数据块 1 从外设到用户工作区的总时间为 105，在这段时间中，数据块 2 没有进行操作。在数据块 1 进行分析处理 时，数据块 2 从外设到用户工作区的总时间为 105，这段时间是并行的。再加上处理数据块 2 的时间 90，总时间为 300，答案为 C。', 9, 'Mogullzr', '2026-02-01 23:08:46', 9, NULL, '2026-02-01 23:08:46', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1087', '3514');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3515, '2013年408考研真题第28题', '简单', '2013年408真题', '下列选项中，会导致用户进程从用户态切换到内核态的操作是（ ）。I. 整数除以零II. sin() 函数调用III. read 系统调用', '[''仅 I、II'', ''仅 I、III'', ''仅 II、III'', ''I、II 和 III'']', "['B']", 'B</font></strong>
需要在系统内核态执行的操作是整数除零操作（需要中断处理）和 read 系统调用函数，sin() 函数调用是在用户态下进行的。', 9, 'Mogullzr', '2026-02-01 23:08:46', 9, NULL, '2026-02-01 23:08:46', 1, 1);
...
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3516, '2013年408考研真题第29题', '简单', '2013年408真题', '计算机开机后，操作系统最终被加载到（  ）。', '[''BIOS'', ''ROM'', ''EPROM'', ''RAM'']', "['D']", 'D</font></strong>
此题为基本常识题，送分题。系统开机后，操作系统的程序会被自动加载到内存中的系统区，这段区域是 RAM。', 9, 'Mogullzr', '2026-02-01 23:08:47', 9, NULL, '2026-02-01 23:08:47', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1222', '3516');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3517, '2013年408考研真题第30题', '简单', '2013年408真题', '若用户进程访问内存时产生缺页，则下列选项中，操作系统可能执行的操作是（ ）。I. 处理越界错II. 置换页III. 分配内存', '[''仅 I、II'', ''仅 II、III'', ''仅 I、III'', ''I、II 和 III'']', "['B']", 'B</font></strong>
用户进程访问内存时缺页会发生缺页中断。发生缺页中断，系统会执行的操作可能是置换页面或分配内存。系统内没有越界的错误，不会进行越界出错处理。', 9, 'Mogullzr', '2026-02-01 23:08:47', 9, NULL, '2026-02-01 23:08:47', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1186', '3517');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3518, '2013年408考研真题第31题', '简单', '2013年408真题', '某系统正在执行三个进程$P_{1}$、$P_{2}$和$P_{3}$，各进程的计算 (CPU) 时间和 I/O 时间比例如下表所示。为提高系统资源利用率，合理的进程优先级设置应为（ ）。', '[''$P_{1} > P_{2} > P_{3}$'', ''$P_{3} > P_{2} > P_{1}$'', ''$P_{2} > P_{1} = P_{3}$'', ''$P_{1} > P_{2} = P_{3}$'']', "['B']", 'B</font></strong>
为了合理地设置进程优先级，应该将进程的 CPU 时间和 I/0 时间做综合考虑，对千 CPU 占用时间较少而 I/O 占用时间较多的进程，优先调度能让 I/O 更早地得到使用，提高了系统的资源利用率，显然应该具有更高的优先级。', 9, 'Mogullzr', '2026-02-01 23:08:47', 9, NULL, '2026-02-01 23:08:47', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1223', '3518');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3519, '2013年408考研真题第32题', '简单', '2013年408真题', '下列关于银行家算法的叙述中，正确的是（ ）。', '[''银行家算法可以预防死锁'', ''当系统处于安全状态时，系统中一定无死锁进程'', ''当系统处于不安全状态时，系统中一定会出现死锁进程'', ''银行家算法破坏了死锁必要条件中的“请求和保持”条件'']', "['B']", 'B</font></strong>
银行家算法是避免死锁的方法，破坏死锁产生的必要条件是预防死锁的方法。利用银行家算法，系统处于安全状态时就可以避免死锁（即此时必然无死锁）；当系统进入不安全状态后便可能进入死锁状态（但也不是必然）。', 9, 'Mogullzr', '2026-02-01 23:08:47', 9, NULL, '2026-02-01 23:08:47', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1185', '3519');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3520, '2013年408考研真题第33题', '简单', '2013年408真题', '在 OSI 参考模型中，下列功能需由应用层的相邻层实现的是（ ）。', '[''对话管理'', ''数据格式转换'', ''路由选择'', ''可靠数据传输'']', "['B']", 'B</font></strong>
在OSI 参考模型中，应用层的相邻层是表示层。表示层是 OSI 七层协议的第六层。表示层的功能是表示出用户看得懂的数据格式，实现与数据表示有关的功能。主要完成数据字符集的转换、数据格式化和文本压缩、数据加密和解密等工作。', 9, 'Mogullzr', '2026-02-01 23:08:47', 9, NULL, '2026-02-01 23:08:47', 1, 1);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/b38f8e59604a46b28950604dd11d08f7.svg)
', '[''0011 0110'', ''1010 1101'', ''0101 0010'', ''1100 0101'']', "['A']", 'A</font></strong>
需要了解传输介质的命名规则：10BaseT 即 10Mbps 的以太网，采用曼彻斯特编码，将一个码元分成两个相等的间隔，前一个间隔为低电平后一个间隔为高电平表示码元 1；码元 0 正好相反，也可以采用相反的规定。故对应比特串可以是 0011 0110 或 1100 1001。', 9, 'Mogullzr', '2026-02-01 23:08:48', 9, NULL, '2026-02-01 23:08:48', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1224', '3521');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3522, '2013年408考研真题第35题', '简单', '2013年408真题', '主机甲通过 1 个路由器（存储转发方式）与主机乙互联，两段链路的数据传输速率均为 10Mbps，主机甲分别采用报文交换和分组大小为 10kb 的分组交换向主机乙发送 1 个大小为 8 Mb（1M = 10⁶ ）的报文。若忽略链路传播延迟、分组头开销和分组拆装时间，则两种交换方式完成该报文传输所需的总时间分别为（ ）。', '[''800 ms、1600 ms'', ''801 ms、1600 ms'', ''1600 ms、800 ms'', ''1600 ms、801 ms'']', "['D']", 'D</font></strong>
本题考察分组交换的传输时间计算，不进行分组时，发送一个报文的时延是 8Mb / 10Mbps = 800s，采用报文交换时，主机甲发送报文需要一次时延，而报文到达路由器进行存储转发又需要一次时延，总时延为 800ms × 2 = 1600ms。进行分组后，发送一个报文的时延是 10kb / 10Mbps = 1ms，一共有 8Mb / 10kb = 800 个分组，主机甲发送 800 个分组需要 1ms × 800 = 800ms 的时延，而路由器接收到第一个分组后直接开始转发，即除了第一个分组，其余分组经过路由器转发不会产生额外的时延，总时延就为 800ms+1ms=801ms。', 9, 'Mogullzr', '2026-02-01 23:08:48', 9, NULL, '2026-02-01 23:08:48', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1160', '3522');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3523, '2013年408考研真题第36题', '简单', '2013年408真题', '下列介质访问控制方法中，可能发生冲突的是（ ）。', '[''CDMA'', ''CSMA'', ''TDMA'', ''FDMA'']', "['B']", 'B</font></strong>
选项 A、C 和 D 都是信道划分协议，信道划分协议是静态划分信道的方法，肯定不会发生冲突。CSMA 全称是载波侦听多路访问协议，其原理是站点在发送数据前先侦听信道，发现信道空闲后再发送，但在发送过程中有可能会发生冲突。', 9, 'Mogullzr', '2026-02-01 23:08:49', 9, NULL, '2026-02-01 23:08:49', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1191', '3523');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3524, '2013年408考研真题第37题', '简单', '2013年408真题', 'HDLC 协议对 01111100 01111110 组帧后对应的比特串为（ ）。', '[''01111100 00111110 10'', ''01111100 01111101 01111110'', ''01111100 01111101 0'', ''01111100 01111110 01111101'']', "['A']", 'A</font></strong>
HDLC 协议对比特串进行组帧时，HDLC 数据帧以位模式 0111 1110 标识每一个帧的开始和结束，因此在帧数据中凡是出现了 5 个连续的位“1”的时候，就会在输出的位流中填充一个“0”。因此组帧后的比特串为 0111 1100 0011 1110 10。', 9, 'Mogullzr', '2026-02-01 23:08:49', 9, NULL, '2026-02-01 23:08:49', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1225', '3524');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3525, '2013年408考研真题第38题', '简单', '2013年408真题', '对于 100 Mbps 的以太网交换机，当输出端口无排队，以直通交换 (cut-through switching) 方式转发一个以太网帧（不包括前导码）时，引入的转发延迟至少是（ ）。', '[''0 μs'', ''0.48 μs'', ''5.12 μs'', ''121.44 μs'']', "['B']", 'B</font></strong>
直通交换在输入端口检测到一个数据帧时，检查帧首部，获取帧的目的地址，启动内部的动态查找表转换成相应的输出端口，在输入与输出交叉处接通，把数据帧直通到相应的端口，实现交换功能。直通交换方式只检查帧的目的地址，共 6B，所以最短的传输延迟是 6 × 8bit / 100Mbps = 0.48μs。', 9, 'Mogullzr', '2026-02-01 23:08:49', 9, NULL, '2026-02-01 23:08:49', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1160', '3525');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3526, '2013年408考研真题第39题', '简单', '2013年408真题', '主机甲与主机乙之间已建立一个 TCP 连接，双方持续有数据传输，且数据无差错与丢失。若甲收到 1 个来自乙的 TCP 段，该段的序号为 1913、确认序号为 2046、有效载荷为 100 字节，则甲立即发送给乙的 TCP 段的序号和确认序号分别是（ ）。', '[''2046、2012'', ''2046、2013'', ''2047、2012'', ''2047、2013'']', "['B']", 'B</font></strong>
本题考察序列号和确认号，确认序号 ack 是期望收到对方下一个报文段的数据的第一个字节的序号，序号 seq 是指本报文段所发送的数据的第一个字节的序号。甲收到 1 个来自乙的 TCP 段，该段的序号 seq=1913、确认序号 ack=2046、有效载荷为 100 字节，表明到序号 1913+100-1=2012 为止的所有数据甲均已收到，而乙期望收到下一个报文段的序号从 2046 开始。故甲发给乙的 TCP 段的序号 seq1=ack=2046 和确认序号 ack1=seq+100=2013。', 9, 'Mogullzr', '2026-02-01 23:08:49', 9, NULL, '2026-02-01 23:08:49', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1126', '3526');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3527, '2013年408考研真题第40题', '简单', '2013年408真题', '下列关于 SMTP 协议的叙述中，正确的是（ ）。I. 只支持传输 7 比特 ASCII 码内容II. 支持在邮件服务器之间发送邮件III. 支持从用户代理向邮件服务器发送邮件IV. 支持从邮件服务器向用户代理发送邮件', '[''仅 I、II 和 III'', ''仅 I、II 和 IV'', ''仅 I、III 和 IV'', ''仅 II、III 和 IV'']', "['A']", 'A</font></strong>
SMTP协议用于用户代理向邮件服务器发送邮件，或在邮件服务器之间发送邮件。SMTP 协议只支持传输 7 比特的 ASCII 码内容。', 9, 'Mogullzr', '2026-02-01 23:08:49', 9, NULL, '2026-02-01 23:08:49', 1, 1);
...
', 9, 'Mogullzr', '2026-02-01 23:08:49', 9, NULL, '2026-02-01 23:08:49', 1, 0);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/17e7abe7dd2b4d92946b8a9960bdb387.svg)
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/a95418f761e94983aa0ba26c84bbfebd.svg)
(3) 实现“无符号数比较小于等于时转移”功能的指令中，C、Z 和 N 应各是什么？(4) 以下是该指令对应的数据通路示意图，要求给出中部件①~③的名称或功能说明。
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/bf8f6feae50548aaa0008c6016b47c79.svg)
...
', 9, 'Mogullzr', '2026-02-01 23:08:53', 9, NULL, '2026-02-01 23:08:53', 1, 0);
...
coend
```
请添加必要的信号量和 P、V（或`wait()`、`signal()`）操作，以实现上述过程中的互斥与同步。要求写出完整的过程，说明信号量的含义并赋初值。', '[]', '', '出入口一次仅允许一个人通过，设置互斥信号量 mutex, 初值为 1。博物馆最多可同时容
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/fd1a02ae09914b52aee2e8142915464e.svg)
则页的大小是多少字节？页表最大占用多少字节？(2) 若使用二级页表的分页存储管理方式，逻辑地址结构为：
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/325d8332ba0840a3a7dfad9222a7ad26.svg)
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/d7e5b00ec2d94d5293a5daf8cd74193c.svg)
...
', 9, 'Mogullzr', '2026-02-01 23:08:57', 9, NULL, '2026-02-01 23:08:57', 1, 0);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/975b78ebfb6245c586946011c06560d8.svg)
请回答下列问题。(1) 假设路由表结构如下表所示。
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/2dc02137d4774a349b4256e111cd8ec5.svg)
...
', 9, 'Mogullzr', '2026-02-01 23:09:00', 9, NULL, '2026-02-01 23:09:00', 1, 0);
