INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3911, '2022年408考研真题第1题', '简单', '2022年408真题', '下列程序段的时间复杂度是（ ）。intsum=0;for(inti=1;i<n;i*=2)for(intj=0;j<i;j++)sum++;', '[''$O(log_{2}n)$'', ''$O(n)$'', ''$O(nlog_{2}n)$'', ''$O(n^{2})$'']', "['B']", 'B
当外层循环的变量$i$取不同值时，内层循环就执行多少次，因此总循环次数为
的所有取值之和。假设外层循环共执行$k$次，当$i = 1, 2, 4, 8, ⋯  , 2^{k-1}(2^{k-1} < n ≤ 2^{k})$时，内层循
环执行$i$次，因此总循环次数$T = 1 + 2 + 4 + 8 + ⋯ + 2^{k-1} = 2^{k} - 1$即$n < T < 2n$，时间复杂度为$O(n)$。', 9, 'Mogullzr', '2026-01-29 18:55:44', 9, NULL, '2026-01-29 18:55:44', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1173', '3911');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3912, '2022年408考研真题第2题', '简单', '2022年408真题', '给定有限符号集 S, in 和 out 均为 S 中所有元素的任意排列。对于初始为空的栈 ST, 下列叙述中，正确的是（ ）。', '[''若 in 是 ST 的入栈序列，则不能判断 out 是否为其可能的出栈序列'', ''若 out 是 ST 的出栈序列，则不能判断 in 是否为其可能的入栈序列'', ''若 in 是 ST 的入栈序列，out 是对应 in 的出栈序列，则 in 与 out 一定不同'', ''若 in 是 ST 的入栈序列，out 是对应 in 的出栈序列，则 in 与 out 可能互为倒序'']', "['D']", 'D
参考入栈出栈序列，如果给定一个入栈序列，我们可以得到其所有可能的出栈序列，所以当给定一个出栈序列时，我们可以判断其是否正确，所以 A、B、C 均为错误选项。', 9, 'Mogullzr', '2026-01-29 18:55:44', 9, NULL, '2026-01-29 18:55:44', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1088', '3912');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3913, '2022年408考研真题第3题', '简单', '2022年408真题', '若结点 p 与 q 在二叉树 T 的中序遍历序列中相邻，且 p 在 q 之前，则下列 p 与 q 的关系中，不可能的是（ ）。I. q 是 p 的双亲II. q 是 p 的右孩子III. q 是 p 的右兄弟IV. q 是 p 的双亲的双亲', '[''仅 I'', ''仅 III'', ''仅 II、III'', ''仅 II、IV'']', "['B']", 'B
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/01/1c3dece70efa44e0a234217beaa11f2f.svg)
', 9, 'Mogullzr', '2026-01-29 18:55:44', 9, NULL, '2026-01-29 18:55:44', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1243', '3913');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3914, '2022年408考研真题第4题', '简单', '2022年408真题', '若三叉树 T 中有 244 个结点（叶结点的高度为 1），则 T 的高度至少是 ( )。', '[''8'', ''7'', ''6'', ''5'']', "['C']", 'C
高度为$n$的二叉树最多有$1 + 2 + ⋯ + 2^{n-1} = 2^{n} - 1$个结点，高度为$n$的三叉树最多有$f(n) = 1 + 3 + ⋯ + 3^{n-1} = \\frac{3^{n}-1}{3-1} - \\frac{3^{n}-1}{2}$。$f(5) = 121$$f(6) = 364$因为$121 < 244 < 364$，所以高度至少为 6。', 9, 'Mogullzr', '2026-01-29 18:55:45', 9, NULL, '2026-01-29 18:55:45', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1144', '3914');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3915, '2022年408考研真题第5题', '简单', '2022年408真题', '对任意给定的含 n (n > 2) 个字符的有限集 S, 用二叉树表示 S 的哈夫曼编码集和定长编码集，分别得到二叉树 T1 和 T2。下列叙述中，正确的是 ( )。', '[''T1 与 T2 的结点数相同'', ''T1 的高度大于 T2 的高度'', ''出现频次不同的字符在 T1 中处于不同的层'', ''出现频次不同的字符在 T2 中处于相同的层'']', "['D']", 'D
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/01/29f200704ff24c758d5721b61aa7967e.svg)
', 9, 'Mogullzr', '2026-01-29 18:55:46', 9, NULL, '2026-01-29 18:55:46', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1145', '3915');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3916, '2022年408考研真题第6题', '简单', '2022年408真题', '对于无向图 G=(V,E)，下列选项中，正确的是（  ）。', '[''当 |V| ＞|E| 时，G 一定是连通的'', ''当 |V| < |E| 时，G 一定是连通的'', ''当 |V| = |E|-1 时，G 一定是不连通的'', ''当 |V| > |E|+1 时，G 一定是不连通的'']', "['D']", 'D
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/01/73c383df04f94c28afbb00e9dc5ea4fc.svg)
', 9, 'Mogullzr', '2026-01-29 18:55:47', 9, NULL, '2026-01-29 18:55:47', 1, 1);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/01/03e9ba4511a149ae855e694d77401930.svg)
', '[''c'', ''g'', ''h'', ''j'']', "['B']", 'B
在 AOE 网中，活动的时间余量 = 结束顶点的最迟开始时间 - 开始顶点的最早开始时间 - 该活动的持续时间。根据关键路径算法得到下表：| 结点编号         | 1 | 2 | 3 | 4 | 5  | 6  |
|:------------:|:-:|:-:|:-:|:-:|:--:|:--:|
| 最早开始时间 ve(i) | 0 | 2 | 5 | 8 | 9  | 12 |
| 最迟开始时间 vl(i) | 0 | 4 | 5 | 8 | 11 | 12 |
c 的时间余量= vl(3) - ve(2) - 1 = 5 - 2 - 1 = 2g 的时间余量 = vl(6) - ve(3) - 1 = 12 - 5 - 1 = 6，h 的时间余量 = vl(5) - ve(4) - 1 = 11 - 8 - 1 = 2j 的时间余量 = vl(6) - ve(5) - 1 = 12 - 9 - 1 = 2，时间余量最大的活动是 g。', 9, 'Mogullzr', '2026-01-29 18:55:49', 9, NULL, '2026-01-29 18:55:49', 1, 1);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/01/a9e9b40fa4d54c0fab0a14acb86c4949.svg)
', '[''60，90，280'', ''60，90，350'', ''60，85，110，350'', ''60，90，110，350'']', "['D']", 'D
参考B 树插入操作，在 5 阶 B 树中，除根结点外的非叶子结点的关键字数 k 需要满足 2 ≤ k ≤ 4。当被删关键字 x 不在终端结点（最底层非叶子结点）时，可以用 x 的前驱（或后继) 关键字 y 来替代 x，然后在相应结点中删除 y。情况①：删除 260，将其前驱 110 放入 260 处，删除 110 后的结点 不满足 5 阶 B 树定义，从左兄弟中借 85，将 85 放入根中，将根中的 90 移入结点 变为 <90, 100>。情况②：删除 260，将其后继 280 放入 260 处，结点 不满足 5 阶 B 树定义且左右兄弟都不够借，结点 可以和左兄弟 <100, 110> 以及关键字 280 合并成一个新的结点 <100, 110, 280, 300>。情况③：在情况②中，结点 也可以和右兄弟 <400, 500> 以及关键字 350 合并成一个新的结点 <300, 350, 400, 500>。综上，T1 根结点中的关键字序列可能是 <60, 85, 110, 350> 或 <60, 90, 350> 或 <60, 90, 280>，仅 D 不可能。', 9, 'Mogullzr', '2026-01-29 18:55:51', 9, NULL, '2026-01-29 18:55:51', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1094', '3918');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3919, '2022年408考研真题第9题', '简单', '2022年408真题', '下列因素中，影响散列（哈希）方法平均查找长度的是（ ）。I. 装填因子II. 散列函数III. 冲突解决策略', '[''仅 I、II'', ''仅 I、III'', ''仅 II、III'', ''I、 II、 III'']', "['D']", 'D
三者都会影响：装填因子越大，说明哈希表中存储的元素越满，发生冲突的可能性越大，平均查找长度也越大。散列函数、突解决策略会影响发生冲突的可能性。', 9, 'Mogullzr', '2026-01-29 18:55:51', 9, NULL, '2026-01-29 18:55:51', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1165', '3919');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3920, '2022年408考研真题第10题', '简单', '2022年408真题', '使用二路归并排序对含 n 个元素的数组 M 进行排序时，二路归并操作的功能是（ ）。', '[''将两个有序表合并为一个新的有序表'', ''将 M 划分为两部分，两部分的元素个数大致相等'', ''将 M 划分为 n 个部分，每个部分中仅含有一个元素'', ''将 M 划分为两部分，一部分元素的值均小于另一部分元素的值'']', "['A']", 'A
概念题，归并针对的对象是序列，二路归并就是将两个有序序列合并成一个。', 9, 'Mogullzr', '2026-01-29 18:55:51', 9, NULL, '2026-01-29 18:55:51', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1195', '3920');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3921, '2022年408考研真题第11题', '简单', '2022年408真题', '对数据进行排序时，若采用直接插入排序而不采用快速排序，则可能的原因是（  ）。I. 大部分元素已有序II. 待排序元素数量很少III. 要求空间复杂度为 O(1)IV. 要求排序算法是稳定的', '[''仅 I、II'', ''仅 III、IV'', ''仅 I、II、IV'', ''I、 II、 III、 IV'']', "['D']", 'D
直接插入排序和快速排序的特点如下表所示：|        | 适合初始序列情况 | 适合元素数量 | 空间复杂度     | 稳定性 |
|:------:|:--------:|:------:|:---------:|:---:|
| 直接插入排序 | 大部分元素有序  | 较少     | O(1)      | 稳定  |
| 快速排序   | 基本无序     | 较多     | O(log2​n) | 不稳定 |
I. 大部分元素已有序✅正确。直接插入排序在序列基本有序的情况下表现非常好，接近 O(n) 的时间复杂度，而快速排序在此场景下仍需要递归处理。因此此项成立。II. 待排序元素数量很少✅正确。当元素数量较少时，插入排序的常数因子小、实现简单，实际运行效率往往优于快速排序，这是实际工程中的常见优化策略（如许多库排序在小规模时使用插入排序）。III. 要求空间复杂度为 O(1)✅正确。插入排序是原地排序，空间复杂度为 O(1)；而快速排序虽然通常也是原地排序，但某些实现（尤其是递归调用）存在 O(log n) 的栈空间。若对空间要求极严，插入排序更适合。IV. 要求排序算法是稳定的✅正确。插入排序是稳定排序，而快速排序是不稳定的（原始版本）。如果应用场景要求排序后相等元素的相对顺序不变，选择插入排序是合理的。综上，所有说法都正确，正确答案选择 D。', 9, 'Mogullzr', '2026-01-29 18:55:51', 9, NULL, '2026-01-29 18:55:51', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1096', '3921');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3922, '2022年408考研真题第12题', '简单', '2022年408真题', '某计算机主频为 1GHz，程序 P 运行过程中，共执行了 10000 条指令，其中，80% 的指令执行平均需 1 个时钟周期，20% 的指令执行平均需 10 个时钟周期。程序 P 的平均 CPI 和 CPU 执行时间分别是（ ）。', '[''2.8，28μs'', ''28，28μs'', ''2.8，28ms'', ''28，28ms'']', "['A']", 'A
...
1011111011100000000000000000000，对应的十六进制格式为 BEE00000H。', 9, 'Mogullzr', '2026-01-29 18:55:51', 9, NULL, '2026-01-29 18:55:51', 1, 1);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/01/03deb69ac0384395a5ad308debc08fff.svg)
', '[''得到主存地址 02 4840H'', ''得到主存地址 18 0840H'', ''得到主存地址 01 8840H'', ''检测到缺页异常'']', "['C']", 'C
本题考察通过单级页表的地址翻译过程。
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/01/052507c5c5744f70bf1bac820c39c0b8.svg)
...
Cache 行数 8，比较器的位数就是 Tag 标记位数 20。', 9, 'Mogullzr', '2026-01-29 18:55:53', 9, NULL, '2026-01-29 18:55:53', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1101', '3926');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3927, '2022年408考研真题第17题', '简单', '2022年408真题', '某内存条包含 8 个 8192×8192×8 位的 DRAM 芯片，按字节编址，支持突发传送方式，对应存储器总线宽度为 64 位，每个 DRAM 芯片内有一个行缓冲区。下列关于该内存条的叙述中，不正确的是（ ）。', '[''内存条的容量为 512MB'', ''采用多模块交叉编址方式'', ''芯片的地址引脚为 26 位'', ''芯片内行缓冲有 8192×8 位'']', "['C']", 'C
本题考察主存容量的扩展。8×8192×8192×8bit=512MB，内存条的容量为 512MB，A 正确。存储器总线宽度 64=8×8bit，而每个芯片一次只能传输 8bit，需要 8 体多模块交叉编址才能实现，B 正确。DRAM 芯片是矩阵样式的行列存储结果，行地址和列地址复用一个地址，根据题意，DRAM 芯片的行数和列数都是 8192，所以引脚个数为$\\log_{2} 8192 = 13$，C 错误。芯片内行数是 8192，一行的大小是 8192×8bit，行缓冲长度就是一行的大小，D 正确。', 9, 'Mogullzr', '2026-01-29 18:55:54', 9, NULL, '2026-01-29 18:55:54', 1, 1);
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3928, '2022年408考研真题第18题', '简单', '2022年408真题', '下列选项中，属于指令集体系结构（ISA）规定的内容是（ ）。Ⅰ. 指令字格式和指令类型Ⅱ. CPU 的时钟周期Ⅲ. 通用寄存器个数和位数Ⅳ. 加法器的进位方式', '[''仅Ⅰ、Ⅱ'', ''仅Ⅰ、Ⅲ'', ''仅Ⅱ、Ⅳ'', ''仅Ⅰ、Ⅲ、Ⅳ'']', "['B']", 'B
指令集处于软硬件的交界面上。指令字和指令格式、通用寄存器个数和位数都与
机器指令有关，由指令体系结构规定。两个 CPU 可以有不同的时钟周期，但指令集可以相同，CPU 的
时钟周期不由 ISA 规定。加法器的进位方式涉及电路设计，也不由指令集规定。', 9, 'Mogullzr', '2026-01-29 18:55:54', 9, NULL, '2026-01-29 18:55:54', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1280', '3928');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3929, '2022年408考研真题第19题', '简单', '2022年408真题', '设计某指令系统时，假设采用 16 位定长指令字格式，操作码使用扩展编码方式，地址码为 6 位，包含零地址、一地址和二地址 3 种格式的指令。若二地址指令有 12 条，一地址指令有 254 条，则零地址指令的条数最多为（ ）。', '[''0'', ''2'', ''64'', ''128'']', "['D']", 'D
本题考察N 地址指令如下图所示：零地址指令的 OP 字段位数相比一地址和二地址指令更短，但是需要注意的是，零地址指令的 OP 字段前缀与一地址和二地址指令的 OP 字段不能相同。
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/01/73d46cad207c4931b55f70ccc0ca2e08.svg)
所以零地址指令的条数为$2^{16} - 254 × 2^{6} - 12 × 2^{12} = 128$。', 9, 'Mogullzr', '2026-01-29 18:55:54', 9, NULL, '2026-01-29 18:55:54', 1, 1);
...
时，可令该进程阻塞，CPU 运行其他进程，D 正确。', 9, 'Mogullzr', '2026-01-29 18:55:56', 9, NULL, '2026-01-29 18:55:56', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1132', '3931');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3932, '2022年408考研真题第22题', '简单', '2022年408真题', '下列关于并行处理技术的叙述中，不正确的是（ ）。', '[''多核处理器属于 MIMD 结构'', ''向量处理器属于 SIMD 结构'', ''硬件多线程技术只可用于多核处理器'', ''SMP 中所有处理器共享单一物理地址空间'']', "['C']", 'C
本题考察多处理器，
...
过存取指令来访问同一片主存地址空间，D 正确。', 9, 'Mogullzr', '2026-01-29 18:55:56', 9, NULL, '2026-01-29 18:55:56', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1318', '3932');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3933, '2022年408考研真题第23题', '简单', '2022年408真题', '下列关于多道程序系统的叙述中，不正确的是（ ）。', '[''支持进程的并发执行'', ''不必支持虚拟存储管理'', ''需要实现对共享资源的管理'', ''进程数越多 CPU 利用率越高'']', "['D']", 'D
操作系统的基本特点：并发、共享、虚拟、异步，其中最基本、一定要实现的是并发和共享，A、C 正确。早期的多道批处理操作系统会将所有进程的数据全部调入主存，再让多道程序并发执行，即使不支持虚拟存储管理，也能实现“多道程序并发”，B 正确。进程多并不意味着 CPU 利用率高，进程数量越多，进程之间的资源竞争越激烈，甚至可能因为资源竞争而出现死锁现象，导致 CPU 利用率低，D 错误。', 9, 'Mogullzr', '2026-01-29 18:55:56', 9, NULL, '2026-01-29 18:55:56', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1110', '3933');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3934, '2022年408考研真题第24题', '简单', '2022年408真题', '下列选项中，需要在操作系统进行初始化过程中创建的是（ ）。', '[''中断向量表'', ''文件系统的根目录'', ''硬盘分区表'', ''文件系统的索引节点表'']', "['A']", 'A
解析：中断向量表：在操作系统启动时，必须初始化中断向量表，用于存储中断服务例程的入口地址，以便处理硬件或软件中断。这是操作系统初始化过程中的关键步骤。文件系统的根目录：根目录通常在文件系统格式化时创建，而不是操作系统初始化过程中。硬盘分区表：分区表是在磁盘分区时创建的，通常在安装操作系统之前完成。文件系统的索引节点表：索引节点表（inode 表）是在文件系统创建时生成的，不是操作系统初始化的一部分。因此，正确答案是 A。', 9, 'Mogullzr', '2026-01-29 18:55:56', 9, NULL, '2026-01-29 18:55:56', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1132', '3934');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3935, '2022年408考研真题第25题', '简单', '2022年408真题', '进程 P0、P1、P2 和 P3 进入就绪队列的时刻、优先级（值越小优先权越高）及 CPU 执行时间如下表所示。若系统采用基于优先权的抢占式进程调度算法，则从 0ms 时刻开始调度，到 4 个进程都运行结束为止，发生进程调度的总次数为（ ）。', '[''4'', ''5'', ''6'', ''7'']', "['C']", 'C
本题考察优先级调度：0 时刻调度进程 P0 获得 CPU；1Oms 时 P2 进入就绪队列，调度 P2 抢占获得 CPU；15ms 时 P3 进入就绪队列，调度 P3 抢占获得 CPU；25ms 时 P3 执行完毕，调度 P2 获得 CPU；40ms 时 P2 执行完毕，调度 P0 获得 CPU；130ms 时 P2 执行完毕，调度 P1 获得 CPU；190ms 时 P2 执行完毕，结束；总共调度 6 次。', 9, 'Mogullzr', '2026-01-29 18:55:56', 9, NULL, '2026-01-29 18:55:56', 1, 1);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/01/423a7ed035e2444e85c50e33080cd3cd.svg)
', '[''1'', ''2'', ''3'', ''4'']', "['B']", 'B
...
所以安全序列可以是 ①P0、P1、P2 或 ②P0、P2、P1。', 9, 'Mogullzr', '2026-01-29 18:55:58', 9, NULL, '2026-01-29 18:55:58', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1185', '3936');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3937, '2022年408考研真题第27题', '简单', '2022年408真题', '下列关于 CPU 模式的叙述中，正确的是（ ）。', '[''CPU 处于用户态时只能执行特权指令'', ''CPU 处于内核态时只能执行特权指令'', ''CPU 处于用户态时只能执行非特权指令'', ''CPU 处于内核态时只能执行非特权指令'']', "['C']", 'C
CPU 在用户态时只能执行非特权指令，在内核态时可以执行特权指令和非特权指令。', 9, 'Mogullzr', '2026-01-29 18:55:58', 9, NULL, '2026-01-29 18:55:58', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1182', '3937');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3938, '2022年408考研真题第28题', '简单', '2022年408真题', '下列事件或操作中，可能导致进程 P 由执行态变为阻塞态的是（ ）。Ⅰ. 进程 P 读文件Ⅱ. 进程 P 的时间片用完Ⅲ. 进程 P 申请外设Ⅳ. 进程 P 执行信号量的 wait() 操作', '[''仅Ⅰ、Ⅳ'', ''仅Ⅱ、Ⅲ'', ''仅Ⅲ、Ⅳ'', ''仅Ⅰ、Ⅲ、Ⅳ'']', "['D']", 'D
参考状态转化。
...
0，则进程进入阻塞态，等待其他进程用 signal() 操作唤醒，V 正确。', 9, 'Mogullzr', '2026-01-29 18:55:58', 9, NULL, '2026-01-29 18:55:58', 1, 1);
...
该页的存在位，B、C、D 正确：如果内存中有空闲页框，就不需要淘汰其他页，A 错误。', 9, 'Mogullzr', '2026-01-29 18:55:58', 9, NULL, '2026-01-29 18:55:58', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1186', '3939');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3940, '2022年408考研真题第30题', '简单', '2022年408真题', '下列选项中，不会影响系统缺页率的是（ ）。', '[''页面置换算法'', ''工作集的大小'', ''进程的数量'', ''页缓冲队列的长度'']', "['D']", 'D
...
回磁盘，队列长度会影响页面置换的速度，但不会影响缺页率，答案选 D。', 9, 'Mogullzr', '2026-01-29 18:55:58', 9, NULL, '2026-01-29 18:55:58', 1, 1);
...
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3941, '2022年408考研真题第31题', '简单', '2022年408真题', '执行系统调用的过程涉及下列操作，其中由操作系统完成的是（ ）。Ⅰ. 保存断点和程序状态字Ⅱ. 保存通用寄存器的内容Ⅲ. 执行系统调用服务程序Ⅳ. 将 CPU 模式改为内核态', '[''仅Ⅰ、Ⅲ'', ''仅Ⅱ、Ⅲ'', ''仅Ⅱ、Ⅳ'', ''仅Ⅱ、Ⅲ、Ⅳ'']', "['B']", 'B
对四个选项进行逐一分析：Ⅰ. 保存断点和程序状态字❌
参考中断处理过程，保存断点由中断隐指令完成，即由硬件完成。Ⅱ. 保存通用寄存器的内容✅
为了防止系统调用覆盖用户程序中的数据，操作系统在进入系统调用处理程序时会保存用户程序的寄存器内容（这属于上下文切换的一部分）。Ⅲ. 执行系统调用服务程序✅
系统调用就是要求操作系统执行某项服务，服务程序是操作系统的一部分，由操作系统调度执行。Ⅳ. 将 CPU 模式改为内核态❌
这一点不是由操作系统主动完成，而是由硬件自动完成的：当执行陷阱指令（如int 0x80）或发生中断时，CPU 自动将模式从用户态切换为内核态，然后跳转到操作系统提供的中断向量地址。所以，这属于硬件响应的一部分，不是由操作系统“显式”控制的。所以正确答案选择 B。', 9, 'Mogullzr', '2026-01-29 18:55:58', 9, NULL, '2026-01-29 18:55:58', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1205', '3941');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3942, '2022年408考研真题第32题', '简单', '2022年408真题', '下列关于驱动程序的叙述中，不正确的是（ ）。', '[''驱动程序与 I/O 控制方式无关'', ''初始化设备是由驱动程序控制完成的'', ''进程在执行驱动程序时可能进入阻塞态'', ''读/写设备的操作是由驱动程序控制完成的'']', "['A']", 'A
...
设备控制器的内部实现，因此也只有厂家提供的驱动程序能控制设备的读/写操作，D 正确。厂家会根据设备特性，在驱动程序中实现一种合适的 I/O 控制方式，A 错误。', 9, 'Mogullzr', '2026-01-29 18:55:59', 9, NULL, '2026-01-29 18:55:59', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1184', '3942');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3943, '2022年408考研真题第33题', '简单', '2022年408真题', '在 ISO/OSI 参考模型中，实现两个相邻结点间流量控制功能的是（ ）。', '[''物理层'', ''数据链路层'', ''网络层'', ''传输层'']', "['B']", 'B
在ISO/OSI 模型中，数据链路层、网络层、传输层都具有流量控制功能，数据链路层是相邻结点之间的流量控制，网络层是整个网络中的流量控制，传输层是端到端的流量控制。', 9, 'Mogullzr', '2026-01-29 18:55:59', 9, NULL, '2026-01-29 18:55:59', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1120', '3943');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3944, '2022年408考研真题第34题', '简单', '2022年408真题', '在一条带宽为 200kHz 的无噪声信道上，若采用 4 个幅值的 ASK 调制，则该信道的最大数据传输速率是（ ）。', '[''200 kbps'', ''400 kbps'', ''800 kbps'', ''1600 kbps'']', "['C']", 'C
根据奈奎斯特定理，最大数据传输速率=$2Wlog_{2}V$，4 个幅值的 ASK 调制说明有 4 个相位，将 V=4 代入，得 800kbps。', 9, 'Mogullzr', '2026-01-29 18:55:59', 9, NULL, '2026-01-29 18:55:59', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1286', '3944');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3945, '2022年408考研真题第35题', '简单', '2022年408真题', '若某主机的 IP 地址是 183.80.72.48, 子网掩码是 255.255.192.0, 则该主机所在网络的网络地址是 (  )。', '[''183.80.0.0'', ''183.80.64.0'', ''183.80.72.0'', ''183.80.192.0'']', "['B']", 'B
主机所在网络的网络地址可以通过主机的 IP 地址和子网掩码逐位相与得到。子网掩码 255.255.192.0 的二进制前 18 位为 1、后 14 位为 0，把主机 P 地址的后 14 位变为 0，得
到的结果为 183.80.64.0，即为主机所在网络的网络地址。', 9, 'Mogullzr', '2026-01-29 18:55:59', 9, NULL, '2026-01-29 18:55:59', 1, 1);
...
像文件，完成传输，总共需要 4 个 RTT，即 40ms。', 9, 'Mogullzr', '2026-01-29 18:56:01', 9, NULL, '2026-01-29 18:56:01', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1197', '3950');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3951, '2022年408考研真题第41题', '简单', '2022年408真题', '已知非空二叉树 T 的结点值均为正整数，采用顺序存储方式保存，数据结构定义如下：typedefstruct{// MAX_SIZE 为已定义常量ElemtypeSqBiTNode[MAX_SIZE];// 保存二叉树结点值的数组intElemNum;// 实际占用的数组元素个数}SqBiTree;T 中不存在的结点在数组 SqBiTNode 中用 -1 表示。例如，对于下图所示的两棵非空二叉树 T1 和 T2：
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/01/31ab5ac40db84a20af8f40a29efd9e45.svg)
T1 的存储结果如下：
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/01/93827d5e81e94a38b84b55df92cff12e.svg)
T2 的存储结果如下：
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/01/cca25944056f49f795ac50cfd42d58ee.svg)
...
使用整型变量val记录中序遍历过程中已遍历结点的最大值，初值为一个负整数，对二叉树进行中序遍历。若当前遍历的结点值小于等于val，则算法返回 false，否则，将val的值更新为当前结点的值。
2）算法实现
// val 存储中序遍历中访问到的最大值// 返回值：当前子树是否为 BSTboolsolve(SqBiTree*tree,intk,int*val){if(k>=tree->ElemNum){// 空结点returntrue;}// 判断左子树是否为 BSTboolret=solve(tree,2*k+1,val);if(!ret){returnfalse;}intcur_val=tree->SqbiTNode[k];if(cur_val==-1){// 空结点returntrue;}// 判断中序序列是否递增if(cur_val>*val){*val=cur_val;}else{returnfalse;}// 判断右子树是否为 BSTret=solve(tree,2*k+2,val);if(!ret){returnfalse;}returntrue;}
', 9, 'Mogullzr', '2026-01-29 18:56:04', 9, NULL, '2026-01-29 18:56:04', 1, 0);
...
', 9, 'Mogullzr', '2026-01-29 18:56:05', 9, NULL, '2026-01-29 18:56:05', 1, 0);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/01/8c91d548622f45bc9a41876fad8807a4.svg)
...
到控制部件的输入端。
', 9, 'Mogullzr', '2026-01-29 18:56:06', 9, NULL, '2026-01-29 18:56:06', 1, 0);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/01/25a70385c9d14403b4836355f9b087e0.svg)
...
用三级间接地址项）。
', 9, 'Mogullzr', '2026-01-29 18:56:08', 9, NULL, '2026-01-29 18:56:08', 1, 0);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/01/2619544b70a84489bb8d1ab7ca29678c.svg)
', '[]', '', '进程 T1 要依次执行 A、E、F。进程 T2 要执行 B、C、D。由图可知，T2 执行 C 必须在 T1
执行完 A 之后；T1 执行 E 必须在 T2 执行完 C 之后。因此，有两对同步关系。信号量的定义
和同步关系的描述如下：
semaphoreAC=0;semaphoreCE=0;T1(){A;signal(AC);wait(CE);E;F;}T2(){B;wait(AC);C;signal(CE);D;}
', 9, 'Mogullzr', '2026-01-29 18:56:09', 9, NULL, '2026-01-29 18:56:09', 1, 0);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/01/921f846761614e2f9a8cb27d80c93d9e.svg)
...
地址 3 是发送端的地址。
', 9, 'Mogullzr', '2026-01-29 18:56:10', 9, NULL, '2026-01-29 18:56:10', 1, 0);
