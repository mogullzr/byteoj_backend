INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3817, '2020年408考研真题第1题', '简单', '2020年408真题', '将一个 10*10 对称矩阵 M 的上三角部分的元素$m_{i,j}(1 ≤ i ≤ j ≤ 10)$，按列优先存入 C 语言的一维数组 N 中，元素$m_{7,2}$在 N 中的下标是（ ）', '[''15'', ''16'', ''22'', ''23'']', "['C']", 'C</font></strong>
...
从 0 开始，故加工 7 在数组 N 中的下标为 2 2 , 即加 7,2 在数组 N 中的下标为 22。', 9, 'Mogullzr', '2026-02-01 23:11:07', 9, NULL, '2026-02-01 23:11:07', 1, 1);
...
| Push | a d e |  |
| Pop | a d | e |
故出栈序列为 c,e。', 9, 'Mogullzr', '2026-02-01 23:11:07', 9, NULL, '2026-02-01 23:11:07', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1088', '3818');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3819, '2020年408考研真题第3题', '简单', '2020年408真题', '对于任意一棵高度为 5 且有 10 个节点的二叉树，若采用顺序存储结构保存，每个结点占 1 个存储单元（仅存放结点的数据信息），则存放该二叉树需要的存储单元数量至少是（ ）。', '[''31'', ''16'', ''15'', ''10'']', "['A']", 'A</font></strong>
二叉树采用顺序存储时，用数组下标来表示结点之间的父子关系。对于一棵高度为 5 的二叉树，为了满足任意性，其 1~5 层的所有结点都要被存储起来，即考虑为一棵高度为 5 的满二叉树，总共需要存储单元的数量为 1 + 2 + 4 + 8 + 16 = 31。', 9, 'Mogullzr', '2026-02-01 23:11:07', 9, NULL, '2026-02-01 23:11:07', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1305', '3819');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3820, '2020年408考研真题第4题', '简单', '2020年408真题', '已知森林 F 及与之对应的二叉树 T，若 F 的先根遍历序列是`a,b,c,d,e,f`，中根遍历序列是`b,a,d,f,e,c`，则 T 的后根遍历序列是（ ）。', '[''b,a,d,f,e,c'', ''b,d,f,e,c,a'', ''b,f,e,d,c,a'', ''f,e,d,c,b,a'']', "['C']", 'C</font></strong>
本题考察的是森林的遍历，
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/7e0ab961763b4528bcbd37d5f05e82b9.svg)
可以得到二叉树 T 的后序序列为 b,f,e,d,c,a。', 9, 'Mogullzr', '2026-02-01 23:11:07', 9, NULL, '2026-02-01 23:11:07', 1, 1);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/b32363e1cd67469aba19aa69155afb4a.svg)
', '[''4，5，2，1，3'', ''4，5，1，2，3'', ''4，2，5，3，1'', ''4，2，1，3，5'']', "['B']", 'B</font></strong>
选项 B 生成二叉排序树的过程如下，显然 B 选项错误：
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/057a0a7a473e40cf9c62368f6e0acc06.svg)
', 9, 'Mogullzr', '2026-02-01 23:11:09', 9, NULL, '2026-02-01 23:11:09', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1174', '3821');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3822, '2020年408考研真题第6题', '简单', '2020年408真题', '修改递归方式实现的图的深度优先搜索（DFS）算法，将输出（访问）定点信息的语句移到退出递归前（即执行输出语句后立刻退出递归）。采用修改后的算法遍历有向无环图 G，若输出结果中包含 G 中的全部顶点，则输出的顶点序列是 G 的（ ）。', '[''拓扑有序序列'', ''逆拓扑有序序列'', ''广度优先搜索序列'', ''深度优先搜索序列'']', "['B']", 'B</font></strong>
DFS是一个递归算法，在遍历过程中，先访问的顶点被压入栈底。设在图中有顶点$v_{i}$，它有后继顶点$v_{j}$，即存在边<$v_{i}$,$v_{j}$>。根据 DFS 的规则，$v_{i}$入栈后，必先遍历完其后继顶点后$v_{j}$才会出栈，也就是说$v_{i}$会在$v_{j}$之后出栈，在如题所指的过程中，$v_{i}$在$v_{j}$后打印。由于$v_{i}$和$v_{j}$具有任意性，从上面的规律可以看出，输出顶点的序列是逆拓扑有序序列。', 9, 'Mogullzr', '2026-02-01 23:11:11', 9, NULL, '2026-02-01 23:11:11', 1, 1);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/ea355e35e3d94412a0f1e7a465263773.svg)
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/db6ceea3f2094f8bb88835b1b063f721.svg)
', 9, 'Mogullzr', '2026-02-01 23:11:12', 9, NULL, '2026-02-01 23:11:12', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1200', '3823');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3824, '2020年408考研真题第8题', '简单', '2020年408真题', '若使 AOE 网估算工程进度则下列叙述中正确的是（ ）。', '[''关键路径是从原点到汇点边数最多的一条路径'', ''关键路径是从原点到汇点路径长度最长的路径'', ''增加任一关键活动的时间不会延长工程的工期'', ''缩短任一关键活动的时间将会缩短工程的工期'']', "['B']", 'B</font></strong>
关键路径是指权值之和最大而非边数最多的路径，故选项 A 错误。选项 B 正确，是关键路径的概念。无论是存在一条还是存在多条关键路径，增加任一关键活动的时间都会延长工程的工期，因为关键路径始终是权值之和最大的那条路径，选项 C 错误。仅有一条关键路径时，减少关键活动的时间会缩短工程的工期；存在多条关键路径时，缩短一条关键活动的时间不一定会缩短工程的工期，缩短了路径长度的那条关键路径不一定还是关键路径，选项 D 错误。', 9, 'Mogullzr', '2026-02-01 23:11:14', 9, NULL, '2026-02-01 23:11:14', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1194', '3824');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3825, '2020年408考研真题第9题', '简单', '2020年408真题', '下列关于大根堆（至少含 2 个元素）的叙述中正确的是（ ）。I. 可以将堆看成一颗完全二叉树；II. 可采用顺序存储方式保存堆；III. 可以将堆看成一棵二叉排序树；IV. 堆中的次大值一定在根的下一层。', '[''仅 I，II'', ''仅 II，III'', ''仅 I，II，IV'', ''仅 I，III，IV'']', "['C']", 'C</font></strong>
堆是一棵完全树，采用一维数组存储，故 I 正确，II 正确。大根堆只要求根结点值大于左右孩子值，并不要求左右孩子值有序，III 错误。堆的定义是递归的，所以其左右子树也是大根堆，所以堆的次大值一定是其左孩子或右孩子，IV 正确。', 9, 'Mogullzr', '2026-02-01 23:11:14', 9, NULL, '2026-02-01 23:11:14', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1095', '3825');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3826, '2020年408考研真题第10题', '简单', '2020年408真题', '依次将关键字 5, 6, 9, 13, 8, 2, 12, 15 插入初始为空的 4 阶 B 树后, 根节点中包含的关键字是（ ）。', '[''8'', ''6, 9'', ''8, 13'', ''9, 12'']', "['B']", 'B</font></strong>
一 个 4 阶B 树的任意非叶结点至多含有加 4-1=3 个关键字，在关键字依次插入的过程中，会导致结点的不断分裂，插入过程如下所示。
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/8192438b290046498d4399137bae472a.svg)
得到根结点包含的关键字为 6, 9。', 9, 'Mogullzr', '2026-02-01 23:11:14', 9, NULL, '2026-02-01 23:11:14', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1094', '3826');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3827, '2020年408考研真题第11题', '简单', '2020年408真题', '对大部分元素已有序的数组进行排序时，直接插入排序比简单选择排序效率更高，其原因是（ ）。I. 直接插入排序过程中元素之间的比较次数更少II. 直接插入排序过程中所需要的辅助空间更少III. 直接插入排序过程中元素的移动次数更少', '[''仅 I'', ''仅 III'', ''仅 I，II'', ''仅 I，II 和 III'']', "['A']", 'A</font></strong>
...
需要依次向后挪位，而简单选择排序只需与找到的最小元素交换位置，后者的移动次数少很多，III 错误。', 9, 'Mogullzr', '2026-02-01 23:11:16', 9, NULL, '2026-02-01 23:11:16', 1, 1);
...
II、指令寄存器
III、通用寄存器
IV、浮点寄存器', '[''Ⅰ，Ⅱ'', ''Ⅰ，Ⅲ'', ''Ⅱ，Ⅲ'', ''Ⅱ，Ⅲ，IV'']', "['B']", 'B</font></strong>
...
- 这与机器字长无固定关系，有的机器字长是 32 位，但支持 64 位浮点数。❌<strong><font color=''#2656b3''>不一定相同</font></strong>所以 I、III 正确，答案选择 B。', 9, 'Mogullzr', '2026-02-01 23:11:16', 9, NULL, '2026-02-01 23:11:16', 1, 1);
...
0000 0000 ,算出 x 值为−7×227。', 9, 'Mogullzr', '2026-02-01 23:11:16', 9, NULL, '2026-02-01 23:11:16', 1, 1);
...
```
若`a`的首地址为 2020FE00H，a 的成员变量`x2`的机器数为 12340000H，则其中 34H 所在存储单元的地址是（ ）。', '[''2020FE03H；'', ''2020FE04H；'', ''2020FE05H；'', ''2020FE06H；'']', "['D']", 'D</font></strong>
在 32 位计算机中，按字节编址，根据小端序和按边界对齐的定义，给出变量 a 的存放方式如下：
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/6cd4992ceec244efa4c65a31a39d7036.svg)
', 9, 'Mogullzr', '2026-02-01 23:11:16', 9, NULL, '2026-02-01 23:11:16', 1, 1);
...
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3831, '2020年408考研真题第15题', '简单', '2020年408真题', '下列关于 TLB 和 Cache 的叙述中，错误的是（ ）。', '[''命中率都与程序局部性有关'', ''缺失后都需要去访问主存'', ''缺失处理都可以由硬件实现'', ''都由 DRAM 存储器组成'']', "['D']", 'D</font></strong>
Cache 由SRAM组成；TLB 通常由相联存储器组成，也可由 SRAM 组成。DRAM需要不断刷新，性能偏低，不适合组成 TLB 和 Cache 选项 A、B 和 C 都是 TLB 和 Cache 的特点。', 9, 'Mogullzr', '2026-02-01 23:11:17', 9, NULL, '2026-02-01 23:11:17', 1, 1);
...
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3832, '2020年408考研真题第16题', '简单', '2020年408真题', '某计算机采用 16 位定长指令字格式，操作码位数和寻址方式位数固定，指令系统有 48 条指令，支持直接、间接、立即、相对 4 种寻址方式，单地址指令中直接寻址方式可寻址范围是（ ）。', '[''0 ~ 255；'', ''0 ~ 1023；'', ''-128 ~ 127；'', ''-512 ~ 511；'']', "['A']", 'A</font></strong>
...
- <strong><font color=''#2656b3''><strong><font color=''#2656b3''>直接寻址不需要符号位</font></strong></font></strong>，它就是一个<strong><font color=''#2656b3''><strong><font color=''#2656b3''>无符号绝对地址</font></strong></font></strong>。', 9, 'Mogullzr', '2026-02-01 23:11:18', 9, NULL, '2026-02-01 23:11:18', 1, 1);
...
类型进行相应的处理，然后返回到“陷阱指令”的下一条指令执行，选 项 D 正确。', 9, 'Mogullzr', '2026-02-01 23:11:18', 9, NULL, '2026-02-01 23:11:18', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1235', '3834');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3835, '2020年408考研真题第19题', '简单', '2020年408真题', 'QPI 总线是一种点对点全工双同步串行总线，总线上的设备可同时接收和发送信息，每个方向可同时传输 20 位信息（16 位数据 + 4 位校验位），每个 QPI 数据包有 80 位信息，分 2 个时钟周期传送，每个时钟周期传递 2 次，因此 QPI 总线带宽为每秒传送次数×2B×2。若 QPI 时钟频率为 2.4GHz，则总线带宽为（ ）。', '[''4.8'', ''9.6'', ''19.2'', ''38.4（单位 GB/s）'']', "['C']", 'C</font></strong>
每个时钟周期传送 2 次，故每秒传送的次数= 时钟频率 x2 = 2.4Gx2/s。总线带宽 = 每秒传送次数×2B×2 = 2.4G×2×2B×2/s=19.2GB/s。题中已给出总线带宽公式，降低了难度。公式中的“x2B”是因为每次传输 16 位数据，“x2”是因为采用点对点全双工总线，两个方向可同时传输信息。', 9, 'Mogullzr', '2026-02-01 23:11:18', 9, NULL, '2026-02-01 23:11:18', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1107', '3835');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3836, '2020年408考研真题第20题', '简单', '2020年408真题', '下列事件中属于外部中断事件的是（ ）。I、访存时缺页；II、定时器到时；III、网络数据包到达；', '[''仅 I、II'', ''仅 I、III'', ''仅 II、III'', ''I、II、III'']', "['C']", 'C</font></strong>
访存时缺页属于内部异常，I 错误；定时器到时描述的是时钟中断，属于外部中断，II 正确；网络数据包到达描述的是 CPU 执行指令以外的事件，属于外部中断，III 正确。', 9, 'Mogullzr', '2026-02-01 23:11:18', 9, NULL, '2026-02-01 23:11:18', 1, 1);
...
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3837, '2020年408考研真题第21题', '简单', '2020年408真题', '外部中断包括不可屏蔽中断（NMI）和可屏蔽中断，下列关于外部中断的叙述中错误的是（ ）。', '[''CPU 处于关中断状态时也能响应 NMI 请求；'', ''一旦可屏蔽中断请求信号有效，CPU 将立即响应；'', ''不可屏蔽中断的优先级比可屏蔽中断的优先级高；'', ''可通过中断屏蔽字改变可屏蔽中断的处理优先级。'']', "['B']", 'B</font></strong>
...
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3839, '2020年408考研真题第23题', '简单', '2020年408真题', '若多个进程共享同一个文件 F，则下列叙述中，正确的是（ ）。', '[''各进程只能用“读”方式打开文件 F'', ''在系统打开文件表中仅有一个表项包含 F 的属性'', ''各进程的用户打开文件表中关于 F 的表项内容相同'', ''进程关闭 F 时，系统删除 F 在系统打开文件表中的表项'']', "['B']", 'B</font></strong>
多个进程可同时以“读”或“写”方式打开文件，操作系统并不保证写操作的互斥性，进程可通过系统调用对文件加锁，保证互斥写（读者 - 写者问题），选项 A 错误。整个系统只有一个系统文件打开表，同一个文件打开多次只需改变引用计数，选项 B 正确。用户进程的打开文件表关于同一个文件不一定相同，例如读写指针位置不一定相同，选项 C 错误。进程关闭文件时，文件的引用计数减 1 , 引用计数变为 0 时才删除系统打开文件表中的表项，选项 D 错误。', 9, 'Mogullzr', '2026-02-01 23:11:18', 9, NULL, '2026-02-01 23:11:18', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1308', '3839');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3840, '2020年408考研真题第24题', '简单', '2020年408真题', '下列选项中，支持文件长度可变、随机访问的磁盘存储空间分配方式是（ ）。', '[''索引分配'', ''链接分配'', ''连续分配'', ''动态分区分配'']', "['A']", 'A</font></strong>
...
项 D 错误。', 9, 'Mogullzr', '2026-02-01 23:11:18', 9, NULL, '2026-02-01 23:11:18', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1115', '3840');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3841, '2020年408考研真题第25题', '简单', '2020年408真题', '下列与中断相关的操作中，由操作系统完成的是（）。Ⅰ、保存被中断程序的中断点Ⅱ、提供中断服务Ⅲ、初始化中断向量表Ⅳ、保存中断屏蔽字', '[''仅Ⅰ、Ⅱ'', ''仅Ⅰ、Ⅱ、Ⅳ'', ''仅Ⅲ、Ⅳ'', ''仅Ⅱ、Ⅲ、Ⅳ'']', "['D']", 'D</font></strong>
...
选项 B 正确，选项 D 错误。', 9, 'Mogullzr', '2026-02-01 23:11:19', 9, NULL, '2026-02-01 23:11:19', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1185', '3843');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3844, '2020年408考研真题第28题', '简单', '2020年408真题', '下列因素中，影响请求分页系统有效（平均）访存时间的是（ ）。Ⅰ. 缺页率Ⅱ. 磁盘读写时间Ⅲ. 内存访问时间Ⅳ. 执行缺页处理程序的 CPU 时间', '[''仅Ⅱ、Ⅲ'', ''仅Ⅰ、Ⅳ'', ''仅Ⅰ、Ⅲ、Ⅳ'', ''Ⅰ、Ⅱ、Ⅲ和Ⅳ'']', "['D']", 'D</font></strong>
I 影响缺页中断的频率，缺页率越高，平均访存时间越长；Ⅱ 和 Ⅳ 影响缺页中断的处理时
间，中断处理时间越长，平均访存时间越长；皿影响访问页表和访问目标物理地址的时间，
故Ⅰ、Ⅱ、Ⅲ 和Ⅳ 均正确。', 9, 'Mogullzr', '2026-02-01 23:11:19', 9, NULL, '2026-02-01 23:11:19', 1, 1);
...
在的唯一标志，每个进程都有自己的 PCB，选项 C 正确。', 9, 'Mogullzr', '2026-02-01 23:11:19', 9, NULL, '2026-02-01 23:11:19', 1, 1);
...
的映射关系，选项 C 正确。应用程序按逻辑设备名访问设备，再经驱动程序的处理来控制物理设备，若更换物理设备，则只需更换驱动程序，而无须修改应用程序，选项 D 错误。', 9, 'Mogullzr', '2026-02-01 23:11:19', 9, NULL, '2026-02-01 23:11:19', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1119', '3846');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3847, '2020年408考研真题第31题', '简单', '2020年408真题', '某文件系统的目录项由文件名和索引结点号构成。若每个目录项长度为 64 字节，其中 4 字节存放索引结点号，60 字节存放文件名。文件名由小写英文字母构成，则该文件系统能创建的文件数量的上限为（ ）。', '[''$2^{26}$'', ''$2^{32}$'', ''$2^{60}$'', ''$2^{64}$'']', "['B']", 'B</font></strong>
在总长为 64 字节的目录项中，索引结点占 4 字节，即 32 位。不同目录下的文件的文件名可以相同，所以在考虑系统创建最多文件数量时，只需考虑索引结点的个数，即创建文件数量上限 = 索引结点数量上限。整个系统中最多存储$2^{32}$个索引结点，因此整个系统最多可以表示$2^{32}$个文件，选项 B 正确。', 9, 'Mogullzr', '2026-02-01 23:11:19', 9, NULL, '2026-02-01 23:11:19', 1, 1);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/1886b3295439412c811f9cf82df3814b.svg)
Ⅰ、语法；Ⅱ、语义；Ⅲ、时序', '[''仅 Ⅰ；'', ''仅 Ⅱ；'', ''仅 Ⅲ；'', ''Ⅰ、Ⅱ、Ⅲ'']', "['C']", 'C</font></strong>
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/157f1459c5fe46579f973c2c15ad6ec6.svg)
', '[''2，2；'', ''2，4；'', ''4，2；'', ''4，4；'']', "['C']", 'C</font></strong>
参考网络设备总结：
网络层设备路由器可以隔离广播域和冲突域；链路层设备普通交换机只能隔离冲突域；物
理层设备集线器、中继器既不能隔离冲突域又不能隔离广播域。因此，题中共有 2 个广播
域、4 个冲突域。', 9, 'Mogullzr', '2026-02-01 23:11:22', 9, NULL, '2026-02-01 23:11:22', 1, 1);
...
发送数据帧和确认帧的时间均为 t= 1000x8b/10kbps = 800ms。发送周期 T = 800ms + 200ms + 800ms + 200ms = 2000ms。信道利用率= t/T x 100% = 800/2000x100% = 40%。', 9, 'Mogullzr', '2026-02-01 23:11:22', 9, NULL, '2026-02-01 23:11:22', 1, 1);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/ef5026ac7d9645819e1163e75ae389a5.svg)
...
的是帧间间隔 DIFS，时间最长，图中 IFS2、IFS3、IFS4 对应 SIFS。', 9, 'Mogullzr', '2026-02-01 23:11:24', 9, NULL, '2026-02-01 23:11:24', 1, 1);
...
由于慢开始门限 ssthresh 可以根据需求设置，为了求拥塞窗口从 8KB 增长到 32KB 所需的最长时间，可以假定慢开始门限小于等于 8KB，只要不出现拥塞，拥塞窗口就都是加法增大，每经历一个传输轮次（RTT），拥塞窗口逐次加 1，所需最长时间为 (32-8)x2ms=48ms。', 9, 'Mogullzr', '2026-02-01 23:11:24', 9, NULL, '2026-02-01 23:11:24', 1, 1);
...
甲与乙建立 TCP 连接时发送的 SYN 段中的序号为 1000，则在数据传输阶段所用的起始序号为 1001；断开连接时，甲发送给乙的 FIN 段中的序号为 5001，在无任何重传的情况下，甲向乙已经发送的应用层数据的字节数为 5001-1001=4000。', 9, 'Mogullzr', '2026-02-01 23:11:24', 9, NULL, '2026-02-01 23:11:24', 1, 1);
...
', 9, 'Mogullzr', '2026-02-01 23:11:25', 9, NULL, '2026-02-01 23:11:25', 1, 0);
...
', 9, 'Mogullzr', '2026-02-01 23:11:26', 9, NULL, '2026-02-01 23:11:26', 1, 0);
...
```
假定某计算机 M 中 ALU 只能进行加减运算和逻辑运算。请回答下列问题。(1) 若 M 的指令系统中没有乘法指令，但有加法、减法和移位等指令，则在 M 上也能实现上述两个函数中的乘法运算，为什么？(2) 若 M 的指令系统中有乘法指令，则基于 ALU、移位器、寄存器以及相应控制逻辑实现乘法指令时，控制逻辑的作用是什么？(3) 针对以下三种情况：
①没有乘法指令；
②有使用 ALU 和移位器实现的乘法指令；
③有使用阵列乘法器实现的乘法指令，
函数`umul()`在哪种情况下执行时间最长？哪种情况下执行的时间最短？说明理由。(4)$n$位整数乘法指令可保存$2n$位乘积，当仅取低$n$位作为乘积时，其结果可能会发生溢出。当$n = 32$、$x = 2^{31} - 1$、$y = 2$时，带符号整数乘法指令和无符号整数乘法指令得到的$x × y$的$2n$位乘积分别是什么（用十六进制表示）？此时函数`umul()`和`imul()`的返回结果是否溢出？对于无符号整数乘法运算，当仅取乘积的低位作为乘法结果时，如何用$2n$位乘积进行溢出判断', '[]', '', '1）乘法运算可以通过加法和移位来实现。编译器可以将乘法运算转换为一个循环代码段，在循环代码段中通过比较、加法和移位等指令实现乘法运算。
...
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3860, '2020年408考研真题第44题', '简单', '2020年408真题', '假定主存地址为 32 位，按字节编址，指令 Cache 和数据 Cache 与主存之间均采用 8 路组相联映射方式，直写（WriteThrough）写策略和 LRU 替换算法，主存块大小为 64B，数据区容量各为 32KB。开始时 Cache 均为空。请回答下列问题。(1) Cache 每一行中标记（Tag）、LRU 位各占几位？是否有修改位？(2) 有如下 C 语言程序段：
```c
for(k = 0; k < 1024; k++)
    s[k] = 2 * s[k];
```
若数组 s 及其变量 k 均为 int 型，int 型数据占 4B，变量 k 分配在寄存器中，数组 s 在主存中的起始地址为 008000C0H，则该程序段执行过程中，访问数组 s 的数据 Cache 缺失次数为多少？(3) 若 CPU 最先开始的访问操作是读取主存单元 00010003H 中的指令，简要说明从 Cache 中访问该指令的过程，包括 Cache 缺失处理过程。', '[]', '', '1）主存块大小为 64B=2 字节，所以主存地址低 6 位为块内地址，Cache 组数为
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/c1c937d69e6d4f5d86dec8ec5b244677.svg)
假设 NAT 转换表结构为：
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/529105eec6af4c1790d54572f23beeb0.svg)
...
', 9, 'Mogullzr', '2026-02-01 23:11:29', 9, NULL, '2026-02-01 23:11:29', 1, 0);
