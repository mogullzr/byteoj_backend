INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4005, '2024年408考研真题第1题', '简单', '2024年408真题', '已知带头结点的非空单链表`L`的头指针为`h`，指针`p`指向`L`中间的一个链表结点（不是第一个和最后一个结点）。`q=p->next`，`p->next=q->next`，`q->next=h->next`，`h->next=q`。这段代码的功能是（）。
', '[''把`q`指向的结点插入到`p`的后面'', ''把`p`指向的结点插入到`q`的后面'', ''把`p`指向的结点插入到`h`的后面'', ''把`q`指向的结点插入到`h`的后面'']', "['D']", 'D</font></strong>
<strong><font color=''#2656b3''>代码分解分析：</font></strong>
```c
q = p->next;
```
现在`q`指向的是`p`的下一个结点。
...
q->next = h->next;
```
这一步将`q->next`指向当前链表的<strong><font color=''#2656b3''>第一个有效结点</font></strong>（注意是`h->next`，即第一个结点，不是头结点）。
```c
h->next = q;
```
把`q`接到头结点之后，也就是插入到链表头部（第一个有效结点之前）。<strong><font color=''#2656b3''>操作的效果是：</font></strong>从链表中间删除了`q`，然后把它插入到了头结点之后，也就是插入到链表第一个有效结点之前。所以这段代码的功能是：<strong><font color=''#2656b3''>把 q 指向的结点插入到 h 的后面</font></strong>正确答案选择<strong><font color=''#2656b3''>D</font></strong>。', 9, 'Mogullzr', '2026-02-02 13:39:38', 9, NULL, '2026-02-02 13:39:38', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1130', '4005');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4006, '2024年408考研真题第2题', '简单', '2024年408真题', '表达式`x+y*(z-u)/v`的等价后缀是（  ）
', '[''`xyzu-*v/+`'', ''`xyzu-v/*+`'', ''`+x/*y-zuv`'', ''`+x*y/-zuv`'']', "['A']", 'A</font></strong>
本题有两种解法：第一种是使用栈将中序转后序。
第二种方式是先将中序表达式转换为二叉树，然后再对二叉树进行后序遍历，得到后续表达式。这里建议使用第二种方式，对于选择题比较高效。', 9, 'Mogullzr', '2026-02-02 13:39:38', 9, NULL, '2026-02-02 13:39:38', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1198', '4006');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4007, '2024年408考研真题第3题', '简单', '2024年408真题', 'p、q、v 都是二叉树 T 中的结点，二叉树 T 的中序遍历为 ···, p，v，q，··· ，其中 v 有两个孩子结点，则下列说法正确的是（ ）。
', '[''p 没右孩子，q 没左孩子'', ''p 没右孩子，q 有左孩子'', ''p 有右孩子，q 没左孩子'', ''p 有右孩子，q 有左孩子'']', "['A']", 'A</font></strong>
根据中序遍历结果和 v 是子树的根节点这些信息，则可以判定 p,q 分别在 v 的的左右子树上，对
于左子树而言，根据中序遍历结果为…p，则没有右孩子，同理，q 没有左孩子。或者假设 p 有右孩子
,q 有左孩子，则中序遍历结果中 p,v 之间一定还有序列，v,q 之间也一定还有序列，和题意冲突。', 9, 'Mogullzr', '2026-02-02 13:39:39', 9, NULL, '2026-02-02 13:39:39', 1, 1);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/a8672619376f41bdb2d6f9c9e546075b.svg)

', '[''0, 2'', ''2, 4'', ''3, 2'', ''2, 3'']', "['B']", 'B</font></strong>
根据邻接多重表还原图，由下图可知，b 的度为 2，d 的图为 4。
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/6494bd45360f495a8d708fec2139108b.svg)
', 9, 'Mogullzr', '2026-02-02 13:39:40', 9, NULL, '2026-02-02 13:39:40', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1326', '4008');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4009, '2024年408考研真题第5题', '简单', '2024年408真题', '下列数据结构中，不适合直接使用折半查找的是（）
I 有序链表 II 无序数组 III 有序静态链表 IV 无序静态链表
', '[''仅 1、II'', ''仅 II、IV'', ''仅、II、IV'', ''I、II、III、IV'']', "['D']", 'D</font></strong>
折半查找需要数据结构支持随机访问才能发挥作用，对于链表，无法随机访问其中某个下标的元素。', 9, 'Mogullzr', '2026-02-02 13:39:41', 9, NULL, '2026-02-02 13:39:41', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1147', '4009');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4010, '2024年408考研真题第6题', '简单', '2024年408真题', 'KMP 算法使用修正后的 next 数组进行模式匹配，模式串 S = “aabaab”，当主串中某字符与 S 中某字符失去配对时，S 将向右滑动的最长距离是（  ）
...
| 元素 | a | a | b | a | a | b |
| next | -1 | 0 | 1 | 0 | 1 | 2 |
| next\\_val | -1 | -1 | 1 | -1 | -1 | 1 |
', 9, 'Mogullzr', '2026-02-02 13:39:41', 9, NULL, '2026-02-02 13:39:41', 1, 1);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/4a3ae9b1723f443d859a46b98b8fb924.svg)

', '[''$X < K_{1}$'', ''$X > K_{2}$'', ''$K_{1} < X < K_{3}$'', ''$K_{3} < X < K_{2}$'']', "['D']", 'D</font></strong>
根据二叉搜索树的性质，$K_{2}$的左子树的节点关键字均小于$K_{2}$，可以得出$K_{3} < K_{2}$，$T$中所有节点小于$K_{2}$，同理也可以得出$K_{3}$的右子树节点均大于$K_{3}$，即$T$中所有节点$> K_{3}$，$X$是$T$中节点，由此可以得出$K_{3} < X < K_{2}$。', 9, 'Mogullzr', '2026-02-02 13:39:43', 9, NULL, '2026-02-02 13:39:43', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1174', '4011');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4012, '2024年408考研真题第8题', '简单', '2024年408真题', '使用快速排序算法对含 N（N ≥ 3） 个元素的数组 M 进行排序，若第一趟排序将除枢轴外的 N-1 个元素划分为 P 和 Q 两个部分，则下列叙述中，正确的是（ ）。
', '[''P 和 Q 块间有序'', ''P 和 Q 均块内有序'', ''P 和 Q 的元素个数大致相等'', ''P 和 Q 中均不存在相等的元素'']', "['A']", 'A</font></strong>
本题考察快排的原理，快排第一趟找到枢轴之后，枢轴的左边的元素即 P 块都是小于枢轴的，枢轴的右边的元素即 Q 块是大于枢轴的，所以 P 和 Q 块间有序，然而块内未必是有序的，所以还需要继续对 P 和 Q 两块进行递归快排。', 9, 'Mogullzr', '2026-02-02 13:39:43', 9, NULL, '2026-02-02 13:39:43', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1231', '4012');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4013, '2024年408考研真题第9题', '简单', '2024年408真题', '已知关键字序列 28, 22, 20, 19, 8, 12, 15, 5 是大根堆（最大堆），对该堆进行两次删除操作后，得到的新堆是（ ）。
', '[''20, 19, 15, 12, 8, 5'', ''20, 19, 15, 5, 8, 12'', ''20, 19, 12, 15, 8, 5'', ''20, 19, 8, 12, 15, 5'']', "['B']", 'B</font></strong>
本题考察堆的删除操作，先根据初始序列建堆，然后依次删除堆项元素，过程如下图：
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/55f919b646114d4e9022cfff7a0af135.svg)
', 9, 'Mogullzr', '2026-02-02 13:39:43', 9, NULL, '2026-02-02 13:39:43', 1, 1);
...
本题考察多路归并的原理，二路归并排序将相邻的有序子序列两两合并，得到合并后有序子序列。重复此过程，直到所有子序列合并为一个有序序列。第一轮归并：将升序序列两两分组，(3,5) 和 (7,9) 分为一组，(6) 分为一组。(3,5) 和 (7,9) 的归并过程如下：
...
| (7,9) |  | 7 | 3,5,6,7 | (9) |
| (9) |  | 9 | 3,5,6,7,9 |  |
到此，二路归并排序执行完毕。上述过程中第一轮归并关键字之间比较 2 次，第二轮归并关键字之间比较 3 次，因此，关键字之间的总比较次数为 2 + 3 = 5。本题选 C。', 9, 'Mogullzr', '2026-02-02 13:39:44', 9, NULL, '2026-02-02 13:39:44', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1195', '4014');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4015, '2024年408考研真题第11题', '简单', '2024年408真题', '在外排序中，利用败者树对初始为升序的归并段进行多路归并，败者树中记录"冠军"的结点保存的是（ ）
', '[''最大关键字'', ''最小关键字'', ''最大关键字所在的归并段号'', ''最小关键字所在的归并段号'']', "['D']", 'D</font></strong>
在外排序的多路归并中，败者树（Loser Tree）是一种优化的数据结构，用于快速找出多个归并段中当前最小的关键字。它是一个完全二叉树，每个非叶子节点保存的是“败者”，而整棵树的根节点保存的是当前“冠军” —— 即：当前最小关键字所在的归并段号。所以答案选择 D。', 9, 'Mogullzr', '2026-02-02 13:39:44', 9, NULL, '2026-02-02 13:39:44', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1327', '4015');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4016, '2024年408考研真题第12题', '简单', '2024年408真题', 'C 语言代码如下：
...
执行上述代码段后， j 的值为（ ）。
', '[''-32777'', ''-32759'', ''32759'', ''32777'']', "['B']", 'B</font></strong>
`int i=32777`，赋值给 short 后，由于 short 只有 16 位，则只会保留 i 的低 16 位，同时，short 的上限为$2^{15} - 1$即 32767，所以 32777 在 short 类型的变量中会出现数据溢出问题，32777=32767+9，则溢出后的二进制补码为 1000000000001001。再将此数转为 int，此时将进行符号扩展，补高 16 位的时候取决于当前 short 的符号位，若符号位为 1，则高 16 位补 16 个 1，若符号位为 0，则高 16 位补 16 个 0，所以本题补 16 个 1，结果为补码 1111 …. 1000 0000 0000 1001，换算成原码再计算，选 B。或者使用排除法，最终通过补码的最高位 1 可以断定该数为负数，A、B 里面选，32777 对于 short 已经溢出，转为 short 再符号扩展，并不只是单纯地改变子符号，故排除 A，选 B。', 9, 'Mogullzr', '2026-02-02 13:39:44', 9, NULL, '2026-02-02 13:39:44', 1, 1);
...
', '[''仅Ⅰ和Ⅳ'', ''仅Ⅱ和Ⅲ'', ''仅Ⅲ和Ⅳ'', ''仅Ⅰ、Ⅲ和Ⅳ'']', "['B']", 'B</font></strong>
伪指令：伪指令不是真正的 CPU 指令，而是由汇编器识别和执行的一些特殊指令。微指令：微指令是计算机硬件级别指令，一条机器指令所完成的操作划分成若干条微指令来完成。机器指令：CPU 可以直接解析和执行的二进制代码。汇编指令：低级别的编程语言，与机器指令一一对应，不过需要汇编器转换为机器指令，CPU 才能执行。这些概念的关系参考该节。', 9, 'Mogullzr', '2026-02-02 13:39:45', 9, NULL, '2026-02-02 13:39:45', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1232', '4017');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4018, '2024年408考研真题第14题', '简单', '2024年408真题', '某科学实验中，需要使用大量的整型参数，为了在保证表数精度的基础上提高运算速度，需要选择合理的数据表示方法。若整型参数$α$和$β$的取值范围分别为$−2^{20} ∼ 2^{20}$、$−2^{40} ∼ 2^{40}$，则下列选项中，$α$和$β$最适宜采用的数据表示方法分别是 (  ）
', '[''32 位整数、32 位整数'', ''单精度浮点数、单精度浮点数'', ''32 位整数、双精度浮点数'', ''单精度浮点数、双精度浮点数'']', "['C']", 'C</font></strong>
a 最适宜采用 32 位整数，32 位整数可以表示$−2^{31} ∼ 2^{31} - 1$的范围，对于 a 的取值范围，可以用 32 位整数表示，不会发生溢出或者精度损失，而且整数运算比浮点数运算更快，更省空间，所以优先使用 32 位整数而不是单精度浮点数。排除 B、D，根据 B 的取值范围，可以使用双精度浮点数存储，双精度浮点数存储范围为$−2^{1023} ∼ 2^{1024}$，不会发生溢出问题，双精度浮点的小数精度为 15-16 位，比起单精度浮点，基本上不会发生精度损失。', 9, 'Mogullzr', '2026-02-02 13:39:45', 9, NULL, '2026-02-02 13:39:45', 1, 1);
...
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4019, '2024年408考研真题第15题', '简单', '2024年408真题', '下列关于整数乘法运算的叙述中，错误的是（ ）。
', '[''用阵列乘法器实现乘运算可以在一个时钟周期完成'', ''用 ALU 和移位器实现的乘运算无法在一个时钟周期内完成'', ''变量与常数的乘运算可编译优化为若干条移位及加/减运算指令'', ''两个变量的乘运算无法编译为移位及加法等指令的循环实现'']', "['D']", 'D</font></strong>
参考该节，我们逐项分析：A.<strong><font color=''#2656b3''>用阵列乘法器实现乘运算可以在一个时钟周期完成</font></strong>✅阵列乘法器（array multiplier）是一种<strong><font color=''#2656b3''>并行结构</font></strong>，硬件资源充足的情况下，确实可以在一个时钟周期内完成乘法运算（代价是面积大）。因此这个说法是<strong><font color=''#2656b3''>正确的</font></strong>。B.<strong><font color=''#2656b3''>用 ALU 和移位器实现的乘运算无法在一个时钟周期内完成</font></strong>✅这种方式对应的是<strong><font color=''#2656b3''>串行乘法器</font></strong>，通过不断地移位与加法模拟乘法过程，至少需要多个时钟周期完成，因此<strong><font color=''#2656b3''>正确</font></strong>。C.<strong><font color=''#2656b3''>变量与常数的乘运算可编译优化为若干条移位及加/减运算指令</font></strong>✅例如`x * 10`可编译为`(x << 3) + (x << 1)`，这是常见的编译器优化技术，因此此项<strong><font color=''#2656b3''>正确</font></strong>。D.<strong><font color=''#2656b3''>两个变量的乘运算无法编译为移位及加法等指令的循环实现</font></strong>❌这项是<strong><font color=''#2656b3''>错误的</font></strong>。事实上，若没有硬件乘法器，编译器或低级代码确实可以将变量之间的乘法（如`a * b`）转换为循环移位加法实现。比如使用<strong><font color=''#2656b3''>Booth 算法</font></strong>、<strong><font color=''#2656b3''>加移法（shift-and-add）</font></strong>等。因此选项 D 的说法是错误的。', 9, 'Mogullzr', '2026-02-02 13:39:45', 9, NULL, '2026-02-02 13:39:45', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1313', '4019');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4020, '2024年408考研真题第16题', '简单', '2024年408真题', '对于页式虚拟存储管理系统，下列关于存储器层次结构的叙述中，错误的是（ ）。
', '[''Cache-主存层次的交换单位为主存块，主存-外存层次的交换单位为页'', ''Cache-主存层次替换算法由硬件实现，主存-外存层次由软件实现'', ''Cache-主存层次可采用回写法写策略，主存-外存层次通常采用回写法'', ''Cache-主存层次可采用直接映射，主存-外存层次通常采用直接映射'']', "['D']", 'D</font></strong>
主存 - 外存层次的映射方式通常采用页式映射，而不是直接映射。页式映射是一种将虚拟地址空间分割为固定大小的单元（页）的映射方式，它将页映射到物理地址的空间的相应单元（页框）中。页式映射的优点是减少了内外存之间的交换次数，提高了空间利用率，缺点是增加了地址转换的开销，需默维护页表。想一想，如果主存 - 外存页面采用直接映射的话，那么替换算法都直接没用了，所以 D 肯定是错误的。', 9, 'Mogullzr', '2026-02-02 13:39:45', 9, NULL, '2026-02-02 13:39:45', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1138', '4020');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4021, '2024年408考研真题第17题', '简单', '2024年408真题', '某计算机按字节编址，采用页式虚拟存储管理方式，虚拟地址为 32 位，主存地址为 30 位，页大小为 1 KB。若 TLB 共有 32 个表项，采用 4 路组相联映射方式，则 TLB 表项中标记字段的位数至少是（ ）。
', '[''17'', ''18'', ''19'', ''20'']', "['C']", 'C</font></strong>
根据题意可知，虚拟地址为 32 位，主存地址为 30 位，页大小为 1KB，因此，虚拟页号为 32-10=22 位，物理页号为 30-10=20 位。TLB 共有 32 个表项，采用 4 路组相联映射方式。因此，TLB 共有 32/4=8 组，每组有 4 路。索引字段为$log_{2}8 = 3$位。标记字段位数 = 虚拟页号位数 - 索引字段位数=22-3=19 位。具体原理可以参考TLB一节。', 9, 'Mogullzr', '2026-02-02 13:39:45', 9, NULL, '2026-02-02 13:39:45', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1136', '4021');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4022, '2024年408考研真题第18题', '简单', '2024年408真题', '下列事件中，不是在 MMU 地址转换过程检测的是（）
', '[''访问越权'', ''Cache 缺失'', ''页面缺失'', ''TLB 缺失'']', "['B']", 'B</font></strong>
MMU负责将虚拟地址转化为物理地址，所以会检测以下事件：访问越权、页面缺失、TLB 缺失。Cache 缺失不是在 MMU 地址转换过程中检测的，而是在 CPU 访问主存数据检测的，访问主存的前提是有物理地址，所以该过程是在 MMU 完成地址翻译之后。', 9, 'Mogullzr', '2026-02-02 13:39:45', 9, NULL, '2026-02-02 13:39:45', 1, 1);
...
', '[''相邻两条指令中的操作数相关可能引起数据冒险'', ''在数据相关的指令间插入“气泡”能避免数据冒险'', ''所有数据冒险都可以通过加入转发（旁路）电路解决'', ''所有数据冒险都能通过调整指令顺序和插入 nop 指令解决'']', "['C']", 'C</font></strong>
本题考查数据冒险。- A 选项正确，比如第一条指令写寄存器，下一条马上读同一个寄存器，就可能发生数据冒险。
...
- D 选项正确，插入气泡即推迟指令后续阶段执行，可以避免所有数据冒险。', 9, 'Mogullzr', '2026-02-02 13:39:45', 9, NULL, '2026-02-02 13:39:45', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1151', '4023');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4024, '2024年408考研真题第20题', '简单', '2024年408真题', '某存储器总线的时钟频率为 420 MHz，总线宽度为 64 位，每个时钟周期传送 2 次数据；其总线事务支持突发传送方式，最多传送 8 次数据，第 1 个时钟周期传送地址和读/写命令，从第 4 个至第 7 个时钟周期连续传送 8 次数据。该总线的总线带宽（最大传输速率）为（ ）。
', '[''3.84GB/s'', ''6.72GB/s'', ''30.72 GB/s'', ''53.76GB/s'']', "['B']", 'B</font></strong>
已知：- 时钟f=420MHz
- 总线宽度w=64bit
- 每个时钟传2次数据（DDR），所以每周期传输次数=2- <strong><font color=''#2656b3''><strong><font color=''#2656b3''>瞬时峰值带宽（只看数据线、连续传数据时）</font></strong></font></strong>每秒传输次数=420×106×2=840×106次/秒， 每次 64 bit。
带宽（比特）=840×106×64=53.76×109bit/s=53.76Gb/s。
换算字节：53.76/8=6.72GB/s。所以瞬时峰值：<strong><font color=''#2656b3''>53.76 Gbit/s = 6.72 GB/s</font></strong>。- <strong><font color=''#2656b3''><strong><font color=''#2656b3''>按题目给出的事务时序（每次事务第1周期发地址/命令，第4~7周期传 8 次数据）计算的有效/持续带宽</font></strong></font></strong>每次事务传输数据量：8×64=512bit=64bytes。
每个事务占用时钟周期数为 7 周期（第1~第7周期），周期时长为1/420MHz。
时间t=7/(420×106)s， 因此有效带宽（字节/s）：
$$
\\frac{64 bytes}{7/(420 × 10^{6}) s} = 3.84 × 10^{9} bytes/s = 3.84 GB/s
$$
比特/s 即$3.84 × 8 = 30.72 Gb/s$。所以按该事务时序的平均最大传输速率（持续带宽）为：<strong><font color=''#2656b3''>30.72 Gbit/s = 3.84 GB/s</font></strong>。<strong><font color=''#2656b3''>结论（按题意的推荐答案）</font></strong>：- 正确答案选择<strong><font color=''#2656b3''><strong><font color=''#2656b3''>B</font></strong></font></strong>，题目中问的是<strong><font color=''#2656b3''><strong><font color=''#2656b3''>最大传输速率</font></strong></font></strong>，指的是<strong><font color=''#2656b3''><strong><font color=''#2656b3''>物理线的理论峰值</font></strong></font></strong>，所以正确答案是<strong><font color=''#2656b3''><strong><font color=''#2656b3''>6.72 GB/s（53.76 Gbit/s）</font></strong></font></strong>。
- 如果题目要求考虑第1周期的地址/命令开销，则答案是<strong><font color=''#2656b3''><strong><font color=''#2656b3''>3.84 GB/s（30.72 Gbit/s）</font></strong></font></strong>；这题属于是出题人故意埋坑，插入了一堆无用信息，属于很令人无语的一道题，正确答案是 B 而不是 A。', 9, 'Mogullzr', '2026-02-02 13:39:45', 9, NULL, '2026-02-02 13:39:45', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1107', '4024');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4025, '2024年408考研真题第21题', '简单', '2024年408真题', '下列关于中断 I/O 方式的叙述中，错误的是（ ）。
', '[''中断屏蔽字用于确定中断响应的优先级'', ''保存断点和程序状态字在中断响应阶段完成'', ''保存通用寄存器和设置新中断屏蔽字由软件实现'', ''单重中断方式下，中断处理时 CPU 处于关中断状态'']', "['A']", 'A</font></strong>
中断是指外部设备或者程序需要 CPU 的服务时，向 CPU 发出一个信号，请求 CPU 暂停当前的任务，转而处理中断请求的情况。中断响应顺序是指当同时有多个中断请求时，CPU 按照一定的优先级顺序来选择响应哪个中断的规则。中断屏蔽字只能控制中断的开关，而不能控制中断的顺序，中断的顺序由中断的优先级决定，优先级高的中断先被响应，优先级低的中断后被响应。', 9, 'Mogullzr', '2026-02-02 13:39:46', 9, NULL, '2026-02-02 13:39:46', 1, 1);
...
', '[''CPU 和主存之间'', ''CPU 和 DMA 控制器之间'', ''设备接口和主存之间'', ''设备接口和 DMA 控制器之间'']', "['C']", 'C</font></strong>
在 DMA 方式中，DMA 控制器控制的数据传输通路位于设备接口和主存之间。这是因为 DMA（Direct Memory Access，直接存储器访问）的主要功能是在外设和存储器之间或者存储器和存储器之间提供高速数据传输。', 9, 'Mogullzr', '2026-02-02 13:39:46', 9, NULL, '2026-02-02 13:39:46', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1133', '4026');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4027, '2024年408考研真题第23题', '简单', '2024年408真题', '下面关于中断和异常的说法中，错误的是（ ）。
', '[''中断或异常发生时，CPU 处于内核态'', ''每个系统调用都有对应的内核服务例程'', ''中断处理程序开始执行时，CPU 处于内核态'', ''系统添加新类型设备时，需注册相应的中断服务例程'']', "['A']", 'A</font></strong>
本题考查中断和异常。- A 错误。中断或异常发生时，CPU 处于用户态。当中断或异常发生时，CPU 会从用户态切换到内核态，然后开始执行相应的中断处理程序或异常处理程序。
...
- D 正确。系统添加新类型设备时，需注册相应的中断服务例程。因为许多设备在发生特定事件时会触发中断，需要相应的中断处理程序来进行处理，该中断处理程序就是中断服务例程。', 9, 'Mogullzr', '2026-02-02 13:39:46', 9, NULL, '2026-02-02 13:39:46', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1109', '4027');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4028, '2024年408考研真题第24题', '简单', '2024年408真题', '下列选项中，操作系统在终止进程时不一定执行的是（）。
', '[''终止子进程'', ''回收分配的内存资源'', ''撤销进程 PCB'', ''回收进程占用的设备'']', "['A']", 'A</font></strong>
当用户终止进程时，不一定终止子进程。因为子进程的生命周期并不总是与父进程紧密相关联，在某些情况下，即使父进程被终止，子进程也可以继续运行，如孤儿进程和僵尸进程。', 9, 'Mogullzr', '2026-02-02 13:39:46', 9, NULL, '2026-02-02 13:39:46', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1153', '4028');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4029, '2024年408考研真题第25题', '简单', '2024年408真题', '在支持页式存储管理的系统中，进程切换时 OS 要执行（）。
I. 更新 PC（程序计数器）值
II. 更新栈基址寄存器值（ebp）
III. 更新页表基址寄存器值
', '[''仅 III'', ''仅 I、II'', ''仅 I、III'', ''I、II、III'']', "['D']", 'D</font></strong>
...
统需要更新页基址寄存器的值，以确保新的进程能正确地访问其内存空间。', 9, 'Mogullzr', '2026-02-02 13:39:46', 9, NULL, '2026-02-02 13:39:46', 1, 1);
...
位置。空闲链表的大小会随着空闲块数量的变化而变化。', 9, 'Mogullzr', '2026-02-02 13:39:46', 9, NULL, '2026-02-02 13:39:46', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1170', '4030');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4031, '2024年408考研真题第27题', '简单', '2024年408真题', '回收分区时，仅合并大小相等的空闲分区的算法是（）。
', '[''伙伴算法'', ''最佳适应算法'', ''最坏适应算法'', ''首次适应算法'']', "['A']", 'A</font></strong>
...
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4034, '2024年408考研真题第30题', '简单', '2024年408真题', '假设某系统使用时间片轮转调度算法进行 CPU 调度，时间片大小为 5 ms，系统共有 10 个进程，初始时均处于就绪队列，执行结束前仅处于执行态或就绪态。若队尾的进程 P 所需 CPU 时间最短，时间为 25 ms。在不考虑系统开销的情况下，则进程 P 的周转时间为（ ）。
', '[''200ms'', ''205ms'', ''250ms'', ''295ms'']', "['C']", 'C</font></strong>
由于使用的是轮转调度算法，进程即在每次执行一个时间片后，都需要重新回到就绪队列的末尾等待下一次的时间片。所以，实际上，进程 P 的每一个时间片之间都有一个完整的轮转周期的等待时间：10×5ms=50ms，进程 P 需要执行 25/5 个时间片，所有中间有 4 个完整的轮转周期再加上 P 的周转时间为，总共需要 5 个轮转周期：5×50ms=250s。', 9, 'Mogullzr', '2026-02-02 13:39:46', 9, NULL, '2026-02-02 13:39:46', 1, 1);
...
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4035, '2024年408考研真题第31题', '简单', '2024年408真题', '键盘中断服务例程执行结束时，所输入的数据存放位置是（） 。
', '[''用户缓冲区'', ''CPU 的通用寄存器'', ''内核缓冲区'', ''键盘控制器的数据缓冲区'']', "['C']", 'C</font></strong>
当键盘输入数据时，首先会将数据发送到键盘控制器的数据寄存器中。当键盘控制器的数据寄存器接收到数据后，它会触发一个中断请求 (IRQ1)，通知 CPU 有数据等待处理。CPU 响应中断请求后，会执行键盘中断服务例程。在中断服务例程中，CPU 从键盘控制器的数据寄存器读取输入数据，并将其存放到内核缓冲区中。A 错误。用户缓冲区通常指的是应用程序为接收输入数据而分配的缓冲区。在键盘中断服务例程执行结束时，输入数据并不会直接存放在用户缓冲区中，而是先存放在内核缓冲区中。应用程序可以通过系统调用或其他机制从内核缓冲区读取输入数据，并将其复制到用户缓冲区中。B 错误。CPU 中的通用寄存器并不是输入数据的最终存放位置。在键盘中断服务例程执行过程中，输入数据可能会暂时存放在 CPU 的通用寄存器中，但最终会被存放到内核缓冲区中。C 正确。内核缓冲区是操作系统用于暂存输入数据的内存区域。在键盘中断服务例程执行过程中，输入数据被读取并存入内核缓冲区，以便后续的系统调用或应用程序访问。内核缓冲区通常由操作系统管理，确保数据的正确性和一致性。D 错误。键盘控制器的数据寄存器是输入数据的初始存放位置，但并不是中断服务例程执行结束时的最终存放位置。本题选 C。', 9, 'Mogullzr', '2026-02-02 13:39:47', 9, NULL, '2026-02-02 13:39:47', 1, 1);
...
', '[''599'', ''619'', ''788'', ''799'']', "['C']", 'C</font></strong>
在CSCAN中，磁头会在一个方向上移动，直到达到磁道的一端，然后立即返回到另一端，再次开始扫描。首先磁头会移动到 160 号磁道，然后依次是 120 号、110 号、0 号，接着磁头移动到开头，然后向磁道号减少的方向移动：依次移动到 399 号、300 号、210 号，完成所有请求后，磁头移动的总距离为：200-160=40；160-110=50；110-0=110；399-0=399；399-300=90；300-210=90；磁头移动的总距离为 40+50+110+399+99+90=788', 9, 'Mogullzr', '2026-02-02 13:39:47', 9, NULL, '2026-02-02 13:39:47', 1, 1);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/36dfba802d504fef91b1fed3541f09f3.svg)

', '[''1Mbps'', ''10Mbps'', ''100Mbps'', ''1000Mbps'']', "['B']", 'B</font></strong>
H1 和 H2 两端的最大传输速率为 10Mbps，虽然中间的路由器最大传输速率为 1000Mbps,
但是根据网路最大流算法，HI 和 H2 的最大吞吐量等价于最大流，最大流为 1OMbps。', 9, 'Mogullzr', '2026-02-02 13:39:48', 9, NULL, '2026-02-02 13:39:48', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1160', '4037');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4038, '2024年408考研真题第34题', '简单', '2024年408真题', '在下列二进制数字调制方法中，需要 2 个不同频率载波的是（）。
', '[''ASP'', ''PSK'', ''FSK'', ''DPSK'']', "['C']", 'C</font></strong>
本题考查调制方法：选项 A：ASK (Amplitude Shift Keying) 幅移键控，这种调制方式是利用载波幅度的变化来传送数字信息的。因此排除选项 A。选项 B：PSK (Phase Shift Keying) 相移键控，这种调制方式是利用载波振荡相位的变化来传送数字信息的。因此排除选项 B。选项 C：FSK (Frequency Shift Keying) 频移键控，这种调制方式是利用载波频率的变化来传送数字信息的。在二进制数字调制中，常见的是二进制 0 和 1 对应不同的频率。因此选项 C 为正确选项。选项 D：DPSK (Differential Phase Shift Keying) 差分相移键控，它不是利用载波相位的绝对数值传送数字信息，而是用前后码元的相对载波相位值传送数字信息。因此排除选项 D。本题选 C。', 9, 'Mogullzr', '2026-02-02 13:39:48', 9, NULL, '2026-02-02 13:39:48', 1, 1);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/188eec946764413c9062e72a9404ebee.svg)

', '[''F1、F3'', ''F1、F4'', ''F3、F1'', ''F4、F1'']', "['D']", 'D</font></strong>
在$t_{1}$时刻主机甲接收到了主机乙发送的 ACKO，暂时没有出错的帧，所以继续发送下一
个数据帧 F4。在$t_{2}$时刻主机甲收到了 F1 超时的错误，根据选择性重传，发送方只需要重传出错的帧，而不是所有的帧，所以只需要重新发送 F1。', 9, 'Mogullzr', '2026-02-02 13:39:51', 9, NULL, '2026-02-02 13:39:51', 1, 1);
...
', '[''30.03s'', ''30.04s'', ''60.03s'', ''60.04s'']', "['D']", 'D</font></strong>
在 TCP 连接中，从建立连接到关闭连接的过程包括以下步骤：- 建立链接：这个过程通常为称为三次握手，SYN、SYN-ACK、ACK，需要一个往返时间 RTT。
- 数据传输：主机 H 向服务器发送长度为 3000B 的报文。由于最大报文段长度 MSS=1000B，第一
次拥塞窗口为 1 发送 1000B，第二次拥塞窗口为 2 发送 2000B，所以一共消耗 2 个最长报文段寿
命，2 个 RTT。
- 关闭连接：这个过程通常称为四次挥手FIN、ACK、FIN、ACK。第一次挥手和第三次挥手构成一个 RTT，第二次和第三次是连续发送的，第四次发出去的时候和客户端等待的 2SL 时间重叠，所以需要 1 个 RTT。所需时间 1RTT+2RTT+1RTT+2MSL=4RTT+2MSL。将 RTT=10ms=0.01s 和 MSL=30s 代入上式，得到 60.04s。', 9, 'Mogullzr', '2026-02-02 13:39:51', 9, NULL, '2026-02-02 13:39:51', 1, 1);
...
', '[''0001 1111 0111 1011'', ''0001 1111 0111 1100'', ''1110 0000 1000 0011'', ''1110 0000 1000 0100'']', "['C']", 'C</font></strong>
UDP 是一种传输层协议，UDP 校验和计算的步骤如下：将 UDP 首部和 UDP 数据字段合并成一个伪首部和一个伪数据字段。伪首部的内容包括源 IP 地址、目
的 IP 地址、协议类型、UDP 数据长度。伪数据字段的内容 UDP 首部和数据字段本身。对伪首部和伪数据字段进行 16 位的字节级求和，得到一个结果。对结果进行反码运算，得到最终的校验和。
```c
  1011 1001 1011 0110
+ 0110 0101 1100 0101
---------------------
...
```
最高位产生进位所以需要在末尾加 1，可得：0001111101111100。取反可得：1110 0000 1000 0011', 9, 'Mogullzr', '2026-02-02 13:39:51', 9, NULL, '2026-02-02 13:39:51', 1, 1);
...
```
', 9, 'Mogullzr', '2026-02-02 13:39:52', 9, NULL, '2026-02-02 13:39:52', 1, 0);
...
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4047, '2024年408考研真题第43题', '简单', '2024年408真题', '假定计算机 M 字长为 32 位。按字节编址，采用 32 位定长指令字，指令`add slli`和`lw`的格式、编码和功能说明如题 43(a) 图所示。

![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/58a3f04928f2469dab44104622e42e78.svg)
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/371d9eb6871248829b5e1bbf95df376a.svg)
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/b624506ce8314d41aea3328d81b331cb.svg)
...
所以`a[i]`的地址 = 首地址 + 偏移量 =`0013 E000 + 4 * (5-1)`=<strong><font color=''#2656b3''>0013 E004H</font></strong>。
a[i]的机器数按照小端编址，所以 DC 作为最低位放在最右边，以此类推可得：a[i] 的机器数 =<strong><font color=''#2656b3''>FFFF ECDCH</font></strong>。
sum 的机器数 = 0000 1332H + FFFF ECDCH = (1) 0000 000EH。由于只有 32 位，所以最高位舍掉后答案为<strong><font color=''#2656b3''>0000 000EH</font></strong>。
页大小为 4KB =$2^{12}$B，所以页内地址占 12 位，去掉后 12 位剩余的则是 20 位页号，a[i] 所在页页号 =<strong><font color=''#2656b3''>0013EH</font></strong>。
我们有 20 位页号，根据题目可知数组跨页号了 0013E 和 0013D，所以数组 a<strong><font color=''#2656b3''>至少存放在 2 页中</font></strong>。
...
机器码 = 0000 0000 0010 0001 0010 0010 0001 0011B =<strong><font color=''#2656b3''>0021 2213H</font></strong>。
若 a 改为 short 类型，slli 指令的汇编形式应该是`slli r4, r2, 1`。
', 9, 'Mogullzr', '2026-02-02 13:39:56', 9, NULL, '2026-02-02 13:39:56', 1, 0);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/a40c958f0679432d9ea17784f11e6e17.svg)
...
计算得到：页表项虚拟地址 = 页表起始虚拟地址 + 页号×4 = B8C00000H + 048H×4 =<strong><font color=''#2656b3''>B8C00120</font></strong>，页表项物理地址 = 页表起始物理地址 + 页号×4 = 65400000H + 048H×4 =<strong><font color=''#2656b3''>65400120H</font></strong>。
最后，我们需要更新页表项中的页框号。由于经过 U 地址转换后得到的物理地址是 BAB4 5678H，我们可以通过右移 22 位得到页框号。
计算得到：页框号 = 物理地址 BAB45678H 的前 10 位，即 10 1110 1010B =<strong><font color=''#2656b3''>2EAH</font></strong>。
2）首先，我们需要确定进程即的页表所在页的页号。由于页表起始虚拟地址位 B8C00000H，我们可以通过右移 22 位得到页号。
计算得到：
进程 P 的页表所在页的页号等于 B8C0 0000 的前 10 位，即 10 1110 0011B =<strong><font color=''#2656b3''>2E3H</font></strong>。
然后，我们需要找到这个页号对应的页表项的虚拟地址。由于页表项的大小为 4 字节，我们可以通过将页号
乘以 4 得到页表项的偏移量。然后将这个偏移量加到页表的起始地址上，就可以得到顷表项的虚拟地址。
计算得到：
该页对应的页表项的虚拟地址 = B8C0 0000H + 2E3H*4 =<strong><font color=''#2656b3''>B8C0 0B8CH</font></strong>。
最后，我们需要确定贡表项中的页框号。由于页表被装在到从物理地址 65400000 开始的连续主存空间中，我们可以通过右移 22 位得到页框号。
计算得到：
该页表项中的页框号等于物理地址 6540 0000H 的前 10 位，即 01 1001 0101B =<strong><font color=''#2656b3''>195H</font></strong>。
', 9, 'Mogullzr', '2026-02-02 13:39:57', 9, NULL, '2026-02-02 13:39:57', 1, 0);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/108697dddeca4466ade6177a5a161ac3.svg)
...
- 最短 AS 路径优先（首要准则）：BGP 会优先选择 AS 路径最短 的路由。
- 若 AS 路径相同，则选取最小的下一跳路由 ID（RID）或基于其他 BGP 规则。
分析 R14 和 R15 的可选路由：
...
', 9, 'Mogullzr', '2026-02-02 13:39:59', 9, NULL, '2026-02-02 13:39:59', 1, 0);
