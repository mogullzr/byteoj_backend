...
h->next = q;
```
把`q`接到头结点之后，也就是插入到链表头部（第一个有效结点之前）。<strong><font color=''#2656b3''>操作的效果是：</font></strong>从链表中间删除了`q`，然后把它插入到了头结点之后，也就是插入到链表第一个有效结点之前。所以这段代码的功能是：<strong><font color=''#2656b3''>把 q 指向的结点插入到 h 的后面</font></strong>正确答案选择<strong><font color=''#2656b3''>D</font></strong>。', 9, 'Mogullzr', '2026-02-01 23:12:45', 9, NULL, '2026-02-01 23:12:45', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1130', '4005');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4006, '2024年408考研真题第2题', '简单', '2024年408真题', '表达式`x+y*(z-u)/v`的等价后缀是（  ）', '[''`xyzu-*v/+`'', ''`xyzu-v/*+`'', ''`+x/*y-zuv`'', ''`+x*y/-zuv`'']', "['A']", 'A</font></strong>
本题有两种解法：第一种是使用栈将中序转后序。
第二种方式是先将中序表达式转换为二叉树，然后再对二叉树进行后序遍历，得到后续表达式。这里建议使用第二种方式，对于选择题比较高效。', 9, 'Mogullzr', '2026-02-01 23:12:45', 9, NULL, '2026-02-01 23:12:45', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1198', '4006');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4007, '2024年408考研真题第3题', '简单', '2024年408真题', 'p、q、v 都是二叉树 T 中的结点，二叉树 T 的中序遍历为 ···, p，v，q，··· ，其中 v 有两个孩子结点，则下列说法正确的是（ ）。', '[''p 没右孩子，q 没左孩子'', ''p 没右孩子，q 有左孩子'', ''p 有右孩子，q 没左孩子'', ''p 有右孩子，q 有左孩子'']', "['A']", 'A</font></strong>
根据中序遍历结果和 v 是子树的根节点这些信息，则可以判定 p,q 分别在 v 的的左右子树上，对
于左子树而言，根据中序遍历结果为…p，则没有右孩子，同理，q 没有左孩子。或者假设 p 有右孩子
,q 有左孩子，则中序遍历结果中 p,v 之间一定还有序列，v,q 之间也一定还有序列，和题意冲突。', 9, 'Mogullzr', '2026-02-01 23:12:45', 9, NULL, '2026-02-01 23:12:45', 1, 1);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/f83eb254ca554743bd44a089bfc5d37f.svg)
', '[''0, 2'', ''2, 4'', ''3, 2'', ''2, 3'']', "['B']", 'B</font></strong>
根据邻接多重表还原图，由下图可知，b 的度为 2，d 的图为 4。
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/c4156cc9d1124d0786b8ee68f17aaf83.svg)
', 9, 'Mogullzr', '2026-02-01 23:12:46', 9, NULL, '2026-02-01 23:12:46', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1326', '4008');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4009, '2024年408考研真题第5题', '简单', '2024年408真题', '下列数据结构中，不适合直接使用折半查找的是（）I 有序链表 II 无序数组 III 有序静态链表 IV 无序静态链表', '[''仅 1、II'', ''仅 II、IV'', ''仅、II、IV'', ''I、II、III、IV'']', "['D']", 'D</font></strong>
折半查找需要数据结构支持随机访问才能发挥作用，对于链表，无法随机访问其中某个下标的元素。', 9, 'Mogullzr', '2026-02-01 23:12:47', 9, NULL, '2026-02-01 23:12:47', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1147', '4009');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4010, '2024年408考研真题第6题', '简单', '2024年408真题', 'KMP 算法使用修正后的 next 数组进行模式匹配，模式串 S = “aabaab”，当主串中某字符与 S 中某字符失去配对时，S 将向右滑动的最长距离是（  ）', '[''5'', ''4'', ''3'', ''2'']', "['A']", 'A</font></strong>
...
', 9, 'Mogullzr', '2026-02-01 23:12:48', 9, NULL, '2026-02-01 23:12:48', 1, 1);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/390d9e9341064831b526d2d70b659016.svg)
', '[''$X < K_{1}$'', ''$X > K_{2}$'', ''$K_{1} < X < K_{3}$'', ''$K_{3} < X < K_{2}$'']', "['D']", 'D</font></strong>
根据二叉搜索树的性质，$K_{2}$的左子树的节点关键字均小于$K_{2}$，可以得出$K_{3} < K_{2}$，$T$中所有节点小于$K_{2}$，同理也可以得出$K_{3}$的右子树节点均大于$K_{3}$，即$T$中所有节点$> K_{3}$，$X$是$T$中节点，由此可以得出$K_{3} < X < K_{2}$。', 9, 'Mogullzr', '2026-02-01 23:12:49', 9, NULL, '2026-02-01 23:12:49', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1174', '4011');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4012, '2024年408考研真题第8题', '简单', '2024年408真题', '使用快速排序算法对含 N（N ≥ 3） 个元素的数组 M 进行排序，若第一趟排序将除枢轴外的 N-1 个元素划分为 P 和 Q 两个部分，则下列叙述中，正确的是（ ）。', '[''P 和 Q 块间有序'', ''P 和 Q 均块内有序'', ''P 和 Q 的元素个数大致相等'', ''P 和 Q 中均不存在相等的元素'']', "['A']", 'A</font></strong>
本题考察快排的原理，快排第一趟找到枢轴之后，枢轴的左边的元素即 P 块都是小于枢轴的，枢轴的右边的元素即 Q 块是大于枢轴的，所以 P 和 Q 块间有序，然而块内未必是有序的，所以还需要继续对 P 和 Q 两块进行递归快排。', 9, 'Mogullzr', '2026-02-01 23:12:49', 9, NULL, '2026-02-01 23:12:49', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1231', '4012');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4013, '2024年408考研真题第9题', '简单', '2024年408真题', '已知关键字序列 28, 22, 20, 19, 8, 12, 15, 5 是大根堆（最大堆），对该堆进行两次删除操作后，得到的新堆是（ ）。', '[''20, 19, 15, 12, 8, 5'', ''20, 19, 15, 5, 8, 12'', ''20, 19, 12, 15, 8, 5'', ''20, 19, 8, 12, 15, 5'']', "['B']", 'B</font></strong>
本题考察堆的删除操作，先根据初始序列建堆，然后依次删除堆项元素，过程如下图：
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/243f1b47acbc4064879b213a525edad8.svg)
', 9, 'Mogullzr', '2026-02-01 23:12:49', 9, NULL, '2026-02-01 23:12:49', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1095', '4013');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4014, '2024年408考研真题第10题', '简单', '2024年408真题', '初始有三个升序序列 (3, 5)、(7, 9)、(6)，若按从左至右的次序选择有序序列进行二路归并排序，则关键字之间的总比较次数是（）。', '[''3'', ''4'', ''5'', ''6'']', "['C']", 'C</font></strong>
...
| (7,9) |  | 7 | 3,5,6,7 | (9) |
| (9) |  | 9 | 3,5,6,7,9 |  |
到此，二路归并排序执行完毕。上述过程中第一轮归并关键字之间比较 2 次，第二轮归并关键字之间比较 3 次，因此，关键字之间的总比较次数为 2 + 3 = 5。本题选 C。', 9, 'Mogullzr', '2026-02-01 23:12:51', 9, NULL, '2026-02-01 23:12:51', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1195', '4014');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4015, '2024年408考研真题第11题', '简单', '2024年408真题', '在外排序中，利用败者树对初始为升序的归并段进行多路归并，败者树中记录"冠军"的结点保存的是（ ）', '[''最大关键字'', ''最小关键字'', ''最大关键字所在的归并段号'', ''最小关键字所在的归并段号'']', "['D']", 'D</font></strong>
在外排序的多路归并中，败者树（Loser Tree）是一种优化的数据结构，用于快速找出多个归并段中当前最小的关键字。它是一个完全二叉树，每个非叶子节点保存的是“败者”，而整棵树的根节点保存的是当前“冠军” —— 即：当前最小关键字所在的归并段号。所以答案选择 D。', 9, 'Mogullzr', '2026-02-01 23:12:51', 9, NULL, '2026-02-01 23:12:51', 1, 1);
...
伪指令：伪指令不是真正的 CPU 指令，而是由汇编器识别和执行的一些特殊指令。微指令：微指令是计算机硬件级别指令，一条机器指令所完成的操作划分成若干条微指令来完成。机器指令：CPU 可以直接解析和执行的二进制代码。汇编指令：低级别的编程语言，与机器指令一一对应，不过需要汇编器转换为机器指令，CPU 才能执行。这些概念的关系参考该节。', 9, 'Mogullzr', '2026-02-01 23:12:51', 9, NULL, '2026-02-01 23:12:51', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1232', '4017');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4018, '2024年408考研真题第14题', '简单', '2024年408真题', '某科学实验中，需要使用大量的整型参数，为了在保证表数精度的基础上提高运算速度，需要选择合理的数据表示方法。若整型参数$α$和$β$的取值范围分别为$−2^{20} ∼ 2^{20}$、$−2^{40} ∼ 2^{40}$，则下列选项中，$α$和$β$最适宜采用的数据表示方法分别是 (  ）', '[''32 位整数、32 位整数'', ''单精度浮点数、单精度浮点数'', ''32 位整数、双精度浮点数'', ''单精度浮点数、双精度浮点数'']', "['C']", 'C</font></strong>
a 最适宜采用 32 位整数，32 位整数可以表示$−2^{31} ∼ 2^{31} - 1$的范围，对于 a 的取值范围，可以用 32 位整数表示，不会发生溢出或者精度损失，而且整数运算比浮点数运算更快，更省空间，所以优先使用 32 位整数而不是单精度浮点数。排除 B、D，根据 B 的取值范围，可以使用双精度浮点数存储，双精度浮点数存储范围为$−2^{1023} ∼ 2^{1024}$，不会发生溢出问题，双精度浮点的小数精度为 15-16 位，比起单精度浮点，基本上不会发生精度损失。', 9, 'Mogullzr', '2026-02-01 23:12:51', 9, NULL, '2026-02-01 23:12:51', 1, 1);
...
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4019, '2024年408考研真题第15题', '简单', '2024年408真题', '下列关于整数乘法运算的叙述中，错误的是（ ）。', '[''用阵列乘法器实现乘运算可以在一个时钟周期完成'', ''用 ALU 和移位器实现的乘运算无法在一个时钟周期内完成'', ''变量与常数的乘运算可编译优化为若干条移位及加/减运算指令'', ''两个变量的乘运算无法编译为移位及加法等指令的循环实现'']', "['D']", 'D</font></strong>
...
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4020, '2024年408考研真题第16题', '简单', '2024年408真题', '对于页式虚拟存储管理系统，下列关于存储器层次结构的叙述中，错误的是（ ）。', '[''Cache-主存层次的交换单位为主存块，主存-外存层次的交换单位为页'', ''Cache-主存层次替换算法由硬件实现，主存-外存层次由软件实现'', ''Cache-主存层次可采用回写法写策略，主存-外存层次通常采用回写法'', ''Cache-主存层次可采用直接映射，主存-外存层次通常采用直接映射'']', "['D']", 'D</font></strong>
主存 - 外存层次的映射方式通常采用页式映射，而不是直接映射。页式映射是一种将虚拟地址空间分割为固定大小的单元（页）的映射方式，它将页映射到物理地址的空间的相应单元（页框）中。页式映射的优点是减少了内外存之间的交换次数，提高了空间利用率，缺点是增加了地址转换的开销，需默维护页表。想一想，如果主存 - 外存页面采用直接映射的话，那么替换算法都直接没用了，所以 D 肯定是错误的。', 9, 'Mogullzr', '2026-02-01 23:12:51', 9, NULL, '2026-02-01 23:12:51', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1138', '4020');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4021, '2024年408考研真题第17题', '简单', '2024年408真题', '某计算机按字节编址，采用页式虚拟存储管理方式，虚拟地址为 32 位，主存地址为 30 位，页大小为 1 KB。若 TLB 共有 32 个表项，采用 4 路组相联映射方式，则 TLB 表项中标记字段的位数至少是（ ）。', '[''17'', ''18'', ''19'', ''20'']', "['C']", 'C</font></strong>
根据题意可知，虚拟地址为 32 位，主存地址为 30 位，页大小为 1KB，因此，虚拟页号为 32-10=22 位，物理页号为 30-10=20 位。TLB 共有 32 个表项，采用 4 路组相联映射方式。因此，TLB 共有 32/4=8 组，每组有 4 路。索引字段为$log_{2}8 = 3$位。标记字段位数 = 虚拟页号位数 - 索引字段位数=22-3=19 位。具体原理可以参考TLB一节。', 9, 'Mogullzr', '2026-02-01 23:12:51', 9, NULL, '2026-02-01 23:12:51', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1136', '4021');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4022, '2024年408考研真题第18题', '简单', '2024年408真题', '下列事件中，不是在 MMU 地址转换过程检测的是（）', '[''访问越权'', ''Cache 缺失'', ''页面缺失'', ''TLB 缺失'']', "['B']", 'B</font></strong>
MMU负责将虚拟地址转化为物理地址，所以会检测以下事件：访问越权、页面缺失、TLB 缺失。Cache 缺失不是在 MMU 地址转换过程中检测的，而是在 CPU 访问主存数据检测的，访问主存的前提是有物理地址，所以该过程是在 MMU 完成地址翻译之后。', 9, 'Mogullzr', '2026-02-01 23:12:52', 9, NULL, '2026-02-01 23:12:52', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1138', '4022');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4023, '2024年408考研真题第19题', '简单', '2024年408真题', '在采用“取指、译码/取数、执行、访存、写回”5 段流水线的 RISC 处理器中，下列关于指令流水线数据冒险处理的叙述中，错误的是（ ）。', '[''相邻两条指令中的操作数相关可能引起数据冒险'', ''在数据相关的指令间插入“气泡”能避免数据冒险'', ''所有数据冒险都可以通过加入转发（旁路）电路解决'', ''所有数据冒险都能通过调整指令顺序和插入 nop 指令解决'']', "['C']", 'C</font></strong>
...
- D 选项正确，插入气泡即推迟指令后续阶段执行，可以避免所有数据冒险。', 9, 'Mogullzr', '2026-02-01 23:12:52', 9, NULL, '2026-02-01 23:12:52', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1151', '4023');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4024, '2024年408考研真题第20题', '简单', '2024年408真题', '某存储器总线的时钟频率为 420 MHz，总线宽度为 64 位，每个时钟周期传送 2 次数据；其总线事务支持突发传送方式，最多传送 8 次数据，第 1 个时钟周期传送地址和读/写命令，从第 4 个至第 7 个时钟周期连续传送 8 次数据。该总线的总线带宽（最大传输速率）为（ ）。', '[''3.84GB/s'', ''6.72GB/s'', ''30.72 GB/s'', ''53.76GB/s'']', "['B']", 'B</font></strong>
已知：- 时钟f=420MHz
- 总线宽度w=64bit
...
- 如果题目要求考虑第1周期的地址/命令开销，则答案是<strong><font color=''#2656b3''><strong><font color=''#2656b3''>3.84 GB/s（30.72 Gbit/s）</font></strong></font></strong>；这题属于是出题人故意埋坑，插入了一堆无用信息，属于很令人无语的一道题，正确答案是 B 而不是 A。', 9, 'Mogullzr', '2026-02-01 23:12:52', 9, NULL, '2026-02-01 23:12:52', 1, 1);
...
中断是指外部设备或者程序需要 CPU 的服务时，向 CPU 发出一个信号，请求 CPU 暂停当前的任务，转而处理中断请求的情况。中断响应顺序是指当同时有多个中断请求时，CPU 按照一定的优先级顺序来选择响应哪个中断的规则。中断屏蔽字只能控制中断的开关，而不能控制中断的顺序，中断的顺序由中断的优先级决定，优先级高的中断先被响应，优先级低的中断后被响应。', 9, 'Mogullzr', '2026-02-01 23:12:52', 9, NULL, '2026-02-01 23:12:52', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1132', '4025');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4026, '2024年408考研真题第22题', '简单', '2024年408真题', 'DMA 方式中，DMA 控制器控制的数据传输通路位于（ ）。', '[''CPU 和主存之间'', ''CPU 和 DMA 控制器之间'', ''设备接口和主存之间'', ''设备接口和 DMA 控制器之间'']', "['C']", 'C</font></strong>
在 DMA 方式中，DMA 控制器控制的数据传输通路位于设备接口和主存之间。这是因为 DMA（Direct Memory Access，直接存储器访问）的主要功能是在外设和存储器之间或者存储器和存储器之间提供高速数据传输。', 9, 'Mogullzr', '2026-02-01 23:12:52', 9, NULL, '2026-02-01 23:12:52', 1, 1);
...
- D 正确。系统添加新类型设备时，需注册相应的中断服务例程。因为许多设备在发生特定事件时会触发中断，需要相应的中断处理程序来进行处理，该中断处理程序就是中断服务例程。', 9, 'Mogullzr', '2026-02-01 23:12:52', 9, NULL, '2026-02-01 23:12:52', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1109', '4027');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4028, '2024年408考研真题第24题', '简单', '2024年408真题', '下列选项中，操作系统在终止进程时不一定执行的是（）。', '[''终止子进程'', ''回收分配的内存资源'', ''撤销进程 PCB'', ''回收进程占用的设备'']', "['A']", 'A</font></strong>
当用户终止进程时，不一定终止子进程。因为子进程的生命周期并不总是与父进程紧密相关联，在某些情况下，即使父进程被终止，子进程也可以继续运行，如孤儿进程和僵尸进程。', 9, 'Mogullzr', '2026-02-01 23:12:52', 9, NULL, '2026-02-01 23:12:52', 1, 1);
...
II. 更新栈基址寄存器值（ebp）
III. 更新页表基址寄存器值', '[''仅 III'', ''仅 I、II'', ''仅 I、III'', ''I、II、III'']', "['D']", 'D</font></strong>
...
统需要更新页基址寄存器的值，以确保新的进程能正确地访问其内存空间。', 9, 'Mogullzr', '2026-02-01 23:12:52', 9, NULL, '2026-02-01 23:12:52', 1, 1);
...
位置。空闲链表的大小会随着空闲块数量的变化而变化。', 9, 'Mogullzr', '2026-02-01 23:12:52', 9, NULL, '2026-02-01 23:12:52', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1170', '4030');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (4031, '2024年408考研真题第27题', '简单', '2024年408真题', '回收分区时，仅合并大小相等的空闲分区的算法是（）。', '[''伙伴算法'', ''最佳适应算法'', ''最坏适应算法'', ''首次适应算法'']', "['A']", 'A</font></strong>
...
且执行速度快，但可能会导致内存的碎片。动态分区分配算法具体参考该节。', 9, 'Mogullzr', '2026-02-01 23:12:53', 9, NULL, '2026-02-01 23:12:53', 1, 1);
...
由于使用的是轮转调度算法，进程即在每次执行一个时间片后，都需要重新回到就绪队列的末尾等待下一次的时间片。所以，实际上，进程 P 的每一个时间片之间都有一个完整的轮转周期的等待时间：10×5ms=50ms，进程 P 需要执行 25/5 个时间片，所有中间有 4 个完整的轮转周期再加上 P 的周转时间为，总共需要 5 个轮转周期：5×50ms=250s。', 9, 'Mogullzr', '2026-02-01 23:12:53', 9, NULL, '2026-02-01 23:12:53', 1, 1);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/e2b0ec3a334c4d52a7bc899f0daa5558.svg)
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/beceab6efb754678b3a06824638ca869.svg)
', '[''F1、F3'', ''F1、F4'', ''F3、F1'', ''F4、F1'']', "['D']", 'D</font></strong>
在$t_{1}$时刻主机甲接收到了主机乙发送的 ACKO，暂时没有出错的帧，所以继续发送下一
个数据帧 F4。在$t_{2}$时刻主机甲收到了 F1 超时的错误，根据选择性重传，发送方只需要重传出错的帧，而不是所有的帧，所以只需要重新发送 F1。', 9, 'Mogullzr', '2026-02-01 23:12:58', 9, NULL, '2026-02-01 23:12:58', 1, 1);
...
则从 H 请求建立 TCP 连接时刻起，到 H 进入 CLOSED 状态为止，所需时间至少是（ ）', '[''30.03s'', ''30.04s'', ''60.03s'', ''60.04s'']', "['D']", 'D</font></strong>
...
命，2 个 RTT。
- 关闭连接：这个过程通常称为四次挥手FIN、ACK、FIN、ACK。第一次挥手和第三次挥手构成一个 RTT，第二次和第三次是连续发送的，第四次发出去的时候和客户端等待的 2SL 时间重叠，所以需要 1 个 RTT。所需时间 1RTT+2RTT+1RTT+2MSL=4RTT+2MSL。将 RTT=10ms=0.01s 和 MSL=30s 代入上式，得到 60.04s。', 9, 'Mogullzr', '2026-02-01 23:12:58', 9, NULL, '2026-02-01 23:12:58', 1, 1);
...
一个 16 位数 0110 0101 1100 0101，则最终计算得到的校验和是（）', '[''0001 1111 0111 1011'', ''0001 1111 0111 1100'', ''1110 0000 1000 0011'', ''1110 0000 1000 0100'']', "['C']", 'C</font></strong>
...
```
最高位产生进位所以需要在末尾加 1，可得：0001111101111100。取反可得：1110 0000 1000 0011', 9, 'Mogullzr', '2026-02-01 23:12:58', 9, NULL, '2026-02-01 23:12:58', 1, 1);
...
```
请设计算法：int uniquely(MGraph G)。判定 G 是否存在唯一的拓扑序列，若是则返回 1，否则返回 0。要求：(1) 给出算法的基本设计思想（4 分）(2) 根据设计思想，采用 C 或 C++ 语言描述算法，关键之处给出注释（9 分）', '[]', '', '1）算法基本设计思想
...
```
', 9, 'Mogullzr', '2026-02-01 23:12:58', 9, NULL, '2026-02-01 23:12:58', 1, 0);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/988db9f4af25479691abf1fd03856c52.svg)
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/d668e39f4179491c913d3472695be5dd.svg)
请回答下列问题(1) 计算机 M 最多有多少个通用寄存器？为什么`shamt`字段占 5 位？（2 分）(2) 执行`add`指令时，控制信号`ALUBsrc`的取值应该是什么？若`rs1`和`rs2`寄存器内容分别是`8765 4321H`和`9876 5432H`，则`add`指令执行后，`ALU`输出端`F`、`OF`和`CF`的结果分别是什么？若设`add`指令处理的是无符号整数，则应根据哪个标志判断是否溢出（3 分）(3) 执行`slli`指令时，控制信号`Ext`的取值可以是 0 也可以是 1，为什么？（2 分）(4) 执行`lw`指令时，控制信号`Ext`、`ALUctr`的取值分别是什么？（2 分）(5) 若一条指令的机器码是`A040 A103H`，则该指令一定是`lw`指令，为什么？(2 分）(6) 若执行该指令时，`R[01H]=FFFF A2D0H`，则所读取数据的存储地址是多少？(2 分）', '[]', '', '1）从 43 题 (a) 图可以看到，Y 寄存器 rs1 和 rs2 用 5 位表示，所以计算机 M 最多的是 2⁵=32 个寄存器。根据指令`R[rd] ← [rs1] << shamt`可知，shamt 表示左移。
...
', 9, 'Mogullzr', '2026-02-01 23:13:01', 9, NULL, '2026-02-01 23:13:01', 1, 0);
...
```
已知变量`i`，`sum`和数组`a`都为 int 型，通用寄存器`r1 - r5`的编号为`01H-05H`。请回答下列问题。（1）根据指令序列`s`中每条指令的功能，写出存放数组`a`的首地址、变参`i`和`sum`的通用寄存器编号（3 分）（2）已知 M 为小端方式，计算机采用页式存储管理方式。页大小为 4KB。若执行到指令序列 s 中第 1 条指令时，`i=5`且`r1`和`r3`的内容分别为`0000 1332H`和`0013 DFF0H`。从地址`0013 DFF0H`开始存储单元内容如题 44 图所示。则执行`sum+=a[i];`语句后。`a[i]`的地址、`a[i]`和`sum`的机器数分别是什么（用十六进制表示）？`a[i]`所在页的页号是多少？在此次执行中，数据组`a`至少存放在几页中？（5 分）
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/b26f406d065f461e9b88db48410a4457.svg)
（3）指令`slli r4, r2, 2`的机器码是什么（用十六进制表示）？若数组`a`改为 short 类型，则指令序列存到 S 中`slli`指令的汇编形式应是什么？', '[]', '</font></strong>
...
', 9, 'Mogullzr', '2026-02-01 23:13:03', 9, NULL, '2026-02-01 23:13:03', 1, 0);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/c51f65f39a844e33beeccba63a5b9a95.svg)
...
', 9, 'Mogullzr', '2026-02-01 23:13:04', 9, NULL, '2026-02-01 23:13:04', 1, 0);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/f1109b1d2bfa470e9d853768c060ad20.svg)
...
', 9, 'Mogullzr', '2026-02-01 23:13:06', 9, NULL, '2026-02-01 23:13:06', 1, 0);
