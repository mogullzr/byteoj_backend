...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/4930b09d65ed47da984c9681b8651485.svg)

', '[''LRN'', ''NRL'', ''RLN'', ''RNL'']', "['D']", 'D</font></strong>
分析遍历后的结点序列，可以看出根结点是在中间访问，而右子树结点在左子树之前，即遍历的方式是 RNL。本题考查的遍历方法并不是二叉树的 3 种基本遍历方式，对于考生而言，重要的是要掌握遍历的思想。', 9, 'Mogullzr', '2026-02-02 13:34:05', 9, NULL, '2026-02-02 13:34:05', 1, 1);
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/8d709a1c38a647f39da0041dffd53e32.svg)

', '''['''' '''', '''' '''', '''' '''', '''' '''']''', "['B']", 'B</font></strong>
根据AVL的定义有，任意结点的左、右子树高度差的绝对值不超过 1。而其余 3 个 选项均可以找到不符合该条件的结点。在做题过程中，如果答案不太明显，可以把每个非叶结点的平衡因子都写出来再进行判断。', 9, 'Mogullzr', '2026-02-02 13:34:06', 9, NULL, '2026-02-02 13:34:06', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1090', '3303');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3304, '2009年408考研真题第5题', '简单', '2009年408真题', '已知一棵完全二叉树的第 6 层（设根为第 1 层）有 8 个叶结点，则该完全二叉树的结点个数最多是（）。
', '[''39'', ''52'', ''111'', ''119'']', "['C']", 'C</font></strong>
完全二叉树比满二叉树只是在最下面一层的右边缺少了部分叶结点，而最后一层之上是个
满二叉树，并且只有最后两层有叶结点。第 6 层有叶结点则完全二叉树的高度可能为 6 或 7，显然树高为 7 时结点更多。若第 6 层上有 8 个叶结点，则前六层为满二叉树，而第 7 层缺失了 8×2=16 个叶结点，故完全二叉树的结点个数最多为$(2^{7} - 1) - 16 = 111$个结点。', 9, 'Mogullzr', '2026-02-02 13:34:06', 9, NULL, '2026-02-02 13:34:06', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1091', '3304');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3305, '2009年408考研真题第6题', '简单', '2009年408真题', '将森林转换为对应的二叉树，若在二叉树中，结点 u 是结点 v 的父结点的父结点，则在原来的森林中，u 和 v 可能具有的关系是（ ）。
I. 父子关系
II. 兄弟关系
III. u 的父结点与 v 的父结点是兄弟关系
', '[''只有 II'', ''I 和 II'', ''I 和 III'', ''I、II 和 III'']', "['B']", 'B</font></strong>
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/68c1b046281d43d9b6f7e6f1bc6b7b5c.svg)
情形 III: 若结点 u 的父结点与 v 的父结点是兄弟关系，则转换后，结点 u 和 v 分别在两者最左父结点的两棵子树中，不可能出现在同 一条路径中。
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/1e5611083f6b4c1aa997271a7e64f1ad.svg)
【逆向法】由题意可知 u 是 v 的父结点的父结点，如下图所示有 4 种情况：
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/48c6eed8c6ac47a3b4a736b2bf910303.svg)
根据树与二叉树的转换规则，将这 4 种情况转换成树种结点的关系。(1) 在原来的树中 u 是 v 的父结点的父结点； (2) 在树中 u 是 v 的父结点； (3) 在树中 u 是 v 的父结点的兄弟； (4) 在树中 u 与 v 是兄弟关系。由此可知 I 和 II 正确。', 9, 'Mogullzr', '2026-02-02 13:34:07', 9, NULL, '2026-02-02 13:34:07', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1092', '3305');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3306, '2009年408考研真题第7题', '简单', '2009年408真题', '下列关于无向连通图特性的叙述中，正确的是（）。
I. 所有顶点的度之和为偶数
II. 边数大于顶点个数减 1
III. 至少有一个顶点的度为 1
', '[''只有 I'', ''只有 II'', ''I 和 II'', ''I 和 III'']', "['A']", 'A</font></strong>
每条边都连接了两个结点，在计算顶点的度之和时每条边都被计算了两次（出度和入度），故所有顶点的度之和为边数的两倍，I 正确。n 个顶点、n-1 条边可以构成无向连通图，比如树，II 错误。顶点数为 N (N≥1) 的无向完全图中不存在度为 1 的顶点，III 错误。', 9, 'Mogullzr', '2026-02-02 13:34:10', 9, NULL, '2026-02-02 13:34:10', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1093', '3306');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3307, '2009年408考研真题第8题', '简单', '2009年408真题', '下列叙述中，不符合 m 阶 B 树定义要求的是（）。
', '[''根节点最多有 m 棵子树'', ''所有叶结点都在同一层上'', ''各结点内关键字均升序或降序排列'', ''叶结点之间通过指针链接'']', "['D']", 'D</font></strong>
选项 A、B 和 C 都是 B-树的特点，而选项 D 则是 B+ 树的特点。注意区别 B-树和 B+ 树各
自的特点。', 9, 'Mogullzr', '2026-02-02 13:34:10', 9, NULL, '2026-02-02 13:34:10', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1094', '3307');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3308, '2009年408考研真题第9题', '简单', '2009年408真题', '已知关键字序列 5，8，12，19，28，20，15，22 是小根堆（最小堆），插入关键字 3，调整后得到的小根堆是（）。
', '[''3，5，12，8，28，20，15，22，19'', ''3，5，12，19，20，15，22，8，28'', ''3，8，12，5，20，15，22，28，19'', ''3，12，5，8，28，20，15，22，19'']', "['A']", 'A</font></strong>
根据关键字序列得到的小根堆的二叉树形式如下图所示。
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/c1d0149868e3493186ba73ae030d6389.svg)
插入关键字 3 时，先将其放在小顶堆的末端，如图 (2) 所示。再将该关键字向上进行调整，得到的结果如图 (3) 所示。所以，调整后的小顶堆序列为 3, 5, 12, 8, 28, 20, 15, 22, 19。', 9, 'Mogullzr', '2026-02-02 13:34:10', 9, NULL, '2026-02-02 13:34:10', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1095', '3308');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3309, '2009年408考研真题第10题', '简单', '2009年408真题', '若数据元素序列 11，12，13，7，8，9，23，4，5 是采用下列排序方法之一得到的第二趟排序后的结果，则该排序算法只能是（）。
', '[''起泡排序'', ''插入排序'', ''选择排序'', ''二路归并排序'']', "['B']", 'B</font></strong>
本题考查各种内部排序算法的特点。对于冒泡排序和选择排序，每一趟都能确定一个元素的最终位置，而题目中，前 2 个元素和后 2 个元素均不是最小或最大的 2 个元素并按序排列。选项 D 中的 2 路归并排序，第一趟排序结束都可以得到若干个有序子序列，而此时的序列中并没有两两元素有序排列。插入排序在每趟排序后能确定前面的若干元素是有序的，而此时第二趟排序后，序列的前三个元素是有序的，符合其特征。', 9, 'Mogullzr', '2026-02-02 13:34:12', 9, NULL, '2026-02-02 13:34:12', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1096', '3309');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3310, '2009年408考研真题第11题', '简单', '2009年408真题', '冯•诺依曼计算机中指令和数据均以二进制形式存放在存储器中，CPU 区分它们的依据是（ ）。
', '[''指令操作码的译码结果'', ''指令和数据的寻址方式'', ''指令周期的不同阶段'', ''指令和数据所在的存储单元'']', "['C']", 'C</font></strong>
虽然在冯诺依曼结构中指令和数据都是以二进制形式存放在存储器中，但 CPU 可以根据指令周期的不同阶段来区分是指令还是数据，通常在取指阶段取出的是指令，在执行阶段取出的是数据。本题容易误选 A，需要清楚的是，CPU 只有在确定取出的是指令之后，才会将其操作码送去译码，因此，不可能依据译码的结果来区分指令和数据。', 9, 'Mogullzr', '2026-02-02 13:34:12', 9, NULL, '2026-02-02 13:34:12', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1097', '3310');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3311, '2009年408考研真题第12题', '简单', '2009年408真题', '一个 C 语言程序在一台 32 位机器上运行。程序中定义了三个变量 x，y 和 z，其中 x 和 z 是 int 型，y 为 short 型。当 x=127，y=-9 时，执行赋值语句 z=x+y 后，x、y 和 z 的值分别是：
', '[''x=0000007FH , y=FFF9H , z=00000076H'', ''x=0000007FH , y=FFF9H , z=FFFF0076H'', ''x=0000007FH , y=FFF7H , z=FFFF0076H'', ''x=0000007FH , y=FFF7H , z=00000076H'']', "['D']", 'D</font></strong>
C 语言中的整型数据为补码表示，int 为 32 位，short 为 16 位，故 x、y 转换成十六进制为 0000007FH、FFF7H。执行 z=x+y 时，由于 x 是 int 型，y 为 short 型，需将短字长数据转换成长字长数据，称之为“符号扩展”。由于 y 的符号位为 1，故在 y 的前面添加 16 个 1，即可将 y 上升为 it 型，其十六进制形式为 FFFFFFF7H。最后执行加法，即 O0OO007FH+FFFFFFF7H=00000076H，其中最高位的进位 1 自然丢弃。故选 D。【排除法】对于 x 的值，4 个选项都一样，无须计算；z=x+y=127-9=118>0，前 4 个字节必然全 0，排除 BC；只需算出 y=-9 的值即可，其十六进制形式为 FFF7H，排除 A。【提示】解题时，应先排除明显错误的选项，然后再推敲剩下的选项。', 9, 'Mogullzr', '2026-02-02 13:34:12', 9, NULL, '2026-02-02 13:34:12', 1, 1);
...
0 开始），因此将映射到 Cache 第 4 组的任一字块中。', 9, 'Mogullzr', '2026-02-02 13:34:12', 9, NULL, '2026-02-02 13:34:12', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1101', '3313');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3314, '2009年408考研真题第15题', '简单', '2009年408真题', '某计算机主存容量为 64KB，其中 ROM 区为 4KB，其余为 RAM 区，按字节编址。现要用 2K×8 位的 ROM 芯片和 4K×4 位的 RAM 芯片来设计该存储器，则需要上述规格的 ROM 芯片数和 RAM 芯片数分别是（）。
', '[''1、15'', ''2、15'', ''1、30'', ''2、30'']', "['D']", 'D</font></strong>
本题考查主存容量的扩展。首先确定 ROM 的个数，ROM 区为 4KB, 选用 2K×8 位的 ROM 芯片，需要 4Kx8 / 2K×8 =2 片，采用字扩展方式：RAM 区为 60KB, 选用 4Kx4 位的 RAM 芯片，需要 60K×8 /4K×4 = 30 片，采用字和位同时扩展方式。', 9, 'Mogullzr', '2026-02-02 13:34:12', 9, NULL, '2026-02-02 13:34:12', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1102', '3314');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3315, '2009年408考研真题第16题', '简单', '2009年408真题', '某机器字长 16 位，主存按字节编址，转移指令采用相对寻址，由两个字节组成，第一字节为操作码字段，第二字节为相对位移量字段。假定取指令时，每取一个字节 PC 自动加 1。若某转移指令所在主存地址为 2000H，相对位移量字段的内容为 06H，则该转移指令成功转移后的目标地址是（）。
', '[''2006H'', ''2007H'', ''2008H'', ''2009H'']', "['C']", 'C</font></strong>
相对寻址EA = (PC)+A，首先要求的是取指令后 PC 的值。转移指令由两个字节组成，每取一个字节 PC 值自动加 1，因此取指令后 PC 值为 2000H+2H = 2002H, 故 EA = (PC)+A = 2002H+06H = 2008H。【易错点】本题易误选 A 或 B。选项 A 没有考虑 PC 值的自动更新，选项 B 虽然考虑了 PC 值要自动更新，但没有注意到该转移指令是一条两字节指令，PC 值仅仅“+1”而不是“+2”。', 9, 'Mogullzr', '2026-02-02 13:34:13', 9, NULL, '2026-02-02 13:34:13', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1103', '3315');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3316, '2009年408考研真题第17题', '简单', '2009年408真题', '下列关于 RISC 的叙述中，错误的是（）。
', '[''RISC 普遍采用微程序控制器'', ''RISC 大多数指令在一个时钟周期内完成'', ''RISC 的内部通用寄存器数量相对 CISC 多'', ''RISC 的指令数、寻址方式和指令格式种类相对 CISC 少'']', "['A']", 'A</font></strong>
相对于CISC，RISC的特点是指令条数少；指令长度固定，指令格式和寻址种类少：只有取数/存数指令访问存储器，其余指令的操作均在寄存器之间进行；CPU 中通用寄存器多；大部分指令在一个或者小于一个机器周期内完成；以硬布线逻辑为主，不用或者少用微程序控制。选项 B、C、D 都是 RISC 的特点，选项 A 是错误的，因为 RISC 的速度快，所以普遍采用硬布线控制器，而非微程序控制器。', 9, 'Mogullzr', '2026-02-02 13:34:13', 9, NULL, '2026-02-02 13:34:13', 1, 1);
...
', '[''90 ns'', ''80 ns'', ''70 ns'', ''60 ns'']', "['A']", 'A</font></strong>
流水线的时钟周期应以最长的执行时间为准，否则用时长的流水段的功能将不能正确完成。', 9, 'Mogullzr', '2026-02-02 13:34:13', 9, NULL, '2026-02-02 13:34:13', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1106', '3317');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3318, '2009年408考研真题第19题', '简单', '2009年408真题', '相对于微程序控制器，硬布线控制器的特点是（）。
', '[''指令执行速度慢，指令功能的修改和扩展容易'', ''指令执行速度慢，指令功能的修改和扩展难'', ''指令执行速度快，指令功能的修改和扩展容易'', ''指令执行速度快，指令功能的修改和扩展难'']', "['D']", 'D</font></strong>
微程序控制器采用了“存储程序”的原理，每条机器指令对应一个微程序，因此修改和扩充容易，灵活性好，但每条指令的执行都要访问控制存储器，所以速度慢。硬布线控制器采用专门的逻辑电路实现，其速度主要取决于逻辑电路的延迟，因此速度快，但修改和扩展困难，灵活性差。', 9, 'Mogullzr', '2026-02-02 13:34:13', 9, NULL, '2026-02-02 13:34:13', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1105', '3318');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3319, '2009年408考研真题第20题', '简单', '2009年408真题', '假设某系统总线在一个总线周期中并行传输 4 字节信息，一个总线周期占用 2 个时钟周期，总线时钟频率为 10MHz，则总线带宽是（）。
', '[''10MB/S'', ''20MB/S'', ''40MB/S'', ''80MB/S'']', "['B']", 'B</font></strong>
总线带宽是指单位时间内总线上传输数据的位数，通常用每秒钟传送信息的字节数来衡量，单位 Bs。由题意可知，在 1 个总线周期（=2 个时钟周期）内传输了 4 字节信息，时钟周期=1/10MHz=0.1μs，故总线带宽为 4B/(2×0.1μs)=4B/(0.2×10⁻⁶s)=20MB/s。', 9, 'Mogullzr', '2026-02-02 13:34:13', 9, NULL, '2026-02-02 13:34:13', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1107', '3319');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3320, '2009年408考研真题第21题', '简单', '2009年408真题', '假设某计算机的存储系统由 Cache 和主存组成，某程序执行过程中访存 1000 次，其中访问 Cache 缺失（未命中）50 次，则 Cache 的命中率是（）。
', '[''5%'', ''9.5%'', ''50%'', ''95%'']', "['D']", 'D</font></strong>
命中率 = Cache 命中次数/总访问次数。需要注意的是看清题，题中说明的是缺失 50 次，而不是命中 50 次，仔细审题是做对题的第一步。', 9, 'Mogullzr', '2026-02-02 13:34:13', 9, NULL, '2026-02-02 13:34:13', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1108', '3320');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3321, '2009年408考研真题第22题', '简单', '2009年408真题', '下列选项中，能引起外部中断的事件是（）。
', '[''键盘输入'', ''除数为 0'', ''浮点运算下溢'', ''访存缺页'']', "['A']", 'A</font></strong>
外部中断指的是 CPU 执行指令以外的事件产生的中断，通常是指来自 CPU 与内存以外的中断。A 中键盘输入属于外部事件，每次键盘输入 CPU 都需要执行中断以读入输入数据，所以能引起外部中断。B 中除数为 0 属于异常，也就是内中断，发生在 CPU 内部。C 中浮点运算下溢将按机器零处理，不会产生中断。而 D 访存缺页属于 CPU 执行指令时产生的中断，也不属于外部中断。所以能产生外部中断的只能是输入设备键盘。', 9, 'Mogullzr', '2026-02-02 13:34:13', 9, NULL, '2026-02-02 13:34:13', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1109', '3321');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3322, '2009年408考研真题第23题', '简单', '2009年408真题', '单处理机系统中，可并行的是（）。
Ⅰ. 进程与进程  Ⅱ. 处理机与设备  Ⅲ. 处理机与通道  Ⅳ. 设备与设备
', '[''Ⅰ、Ⅱ、Ⅲ'', ''Ⅰ、Ⅱ、Ⅳ'', ''Ⅰ、Ⅲ、Ⅳ'', ''Ⅱ、Ⅲ、Ⅳ'']', "['D']", 'D</font></strong>
在单处理机系统（不包含多核的情况）中，同一时刻只能有一个进程占用处理机，因此进程之间不能并行执行。通道是独立于 CPU 的控制输入／输出的设备，两者可以并行，显然，设备与设备之间也是可以并行的。', 9, 'Mogullzr', '2026-02-02 13:34:13', 9, NULL, '2026-02-02 13:34:13', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1110', '3322');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3323, '2009年408考研真题第24题', '简单', '2009年408真题', '下列进程调度算法中，综合考虑进程等待时间和执行时间的是（）。
', '[''时间片轮转调度算法'', ''短进程优先调度算法'', ''先来先服务调度算法'', ''高响应比优先调度算法'']', "['D']", 'D</font></strong>
在最高响应比优先算法中，选出响应比最高的进程投入执行，响应比 R 定义如下：响应比 R = (等待时间＋执行时间) / 执行时间。它综合考虑了每个进程的等待时间和执行时间，对于同时到达的长进程和短进程，短进程会优先执行，以提高系统吞吐量；而长进程的响应比可以随等待时间的增加而提高，不会产生进程无法调度的情况。', 9, 'Mogullzr', '2026-02-02 13:34:13', 9, NULL, '2026-02-02 13:34:13', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1111', '3323');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3324, '2009年408考研真题第25题', '简单', '2009年408真题', '某计算机系统中有 8 台打印机，由 K 个进程竞争使用，每个进程最多需要 3 台打印机。该系统可能会发生死锁的 K 的最小值是（）。
...
个情况就是极端情况，K 为 4。', 9, 'Mogullzr', '2026-02-02 13:34:13', 9, NULL, '2026-02-02 13:34:13', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1112', '3324');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3325, '2009年408考研真题第26题', '简单', '2009年408真题', '分区分配内存管理方式的主要保护措施是（）。
', '[''界地址保护'', ''程序代码保护'', ''数据保护'', ''栈保护'']', "['A']", 'A</font></strong>
每个进程都拥有自己独立的内存空间，若一个进程在运行时所产生的地址在其地址空间之外，则发生地址越界，因此需要进行界地址保护，即当程序要访问某个内存单元时，由硬件检查是否允许，如果允许则执行，否则产生地址越界中断。', 9, 'Mogullzr', '2026-02-02 13:34:14', 9, NULL, '2026-02-02 13:34:14', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1113', '3325');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3326, '2009年408考研真题第27题', '简单', '2009年408真题', '一个分段存储管理系统中，地址长度为 32 位，其中段号占 8 位，则最大段长是（）。
', '[''$2^{8}$字节'', ''$2^{16}$字节'', ''$2^{24}$字节'', ''$2^{32}$字节'']', "['C']", 'C</font></strong>
段式管理的逻辑地址分为段号和位移量两部分，段内位移的最大值就是最大段长。地址长度为 32 位，段号占 8 位，则位移量占 32-8=24 位，故最大段长为$2^{24}$B。', 9, 'Mogullzr', '2026-02-02 13:34:14', 9, NULL, '2026-02-02 13:34:14', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1114', '3326');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3327, '2009年408考研真题第28题', '简单', '2009年408真题', '下列文件物理结构中，适合随机访问且易于文件扩展的是（）。
', '[''连续结构'', ''索引结构'', ''链式结构且磁盘块定长'', ''链式结构且磁盘块变长'']', "['B']", 'B</font></strong>
文件的物理结构包括连续、链式、索引三种，其中链式结构不能 实现随机访问，连续结构的文件不易于扩展。因此随机访问且易于扩展是索引结构的特性。', 9, 'Mogullzr', '2026-02-02 13:34:14', 9, NULL, '2026-02-02 13:34:14', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1115', '3327');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3328, '2009年408考研真题第29题', '简单', '2009年408真题', '假设磁头当前位于第 105 道，正在向磁道序号增加的方向移动。现有一个磁道访问请求序列为 35，45，12，68，110，180，170，195，采用 SCAN 调度（电梯调度）算法得到的磁道访问序列是（）。
', '[''110,170,180,195,68,45,35,12'', ''110,68,45,35,12,170,180,195'', ''110,170,180,195,12,35,45,68'', ''12,35,45,68,110,170,180,195'']', "['A']", 'A</font></strong>
SCAN算法类似电梯的工作原理。首先，当磁头从 105 道向序号增加的方向移动时，便会按照从小到大的顺序服务 所有大于 105 的磁道号 (110,170,180,195)；往回移动时又会按照从大到小的顺序进行服务 (68, 45,35, 12)。', 9, 'Mogullzr', '2026-02-02 13:34:14', 9, NULL, '2026-02-02 13:34:14', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1116', '3328');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3329, '2009年408考研真题第30题', '简单', '2009年408真题', '文件系统中，文件访问控制信息存储的合理位置是（）。
', '[''文件控制块'', ''文件分配表'', ''用户口令表'', ''系统注册表'']', "['A']", 'A</font></strong>
为了实现“按名存取”，在文件系统中为每个文件设置用于描述和控制文件的数据结构，称之为文件控制块 (FCB )。在文件控制块中，通常包含以下三类信息，即基本信息、存取控制信息及使用信息。', 9, 'Mogullzr', '2026-02-02 13:34:14', 9, NULL, '2026-02-02 13:34:14', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1117', '3329');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3330, '2009年408考研真题第31题', '简单', '2009年408真题', '设文件 F1 的当前引用计数值为 1，先建立 F1 的符号链接（软链接）文件 F2，再建立 F1 的硬链接文件 F3，然后删除 F1。此时，F2 和 F3 的引用计数值分别是（）。
', '[''0、1'', ''1、1'', ''1、2'', ''2、1'']', "['B']", 'B</font></strong>
符号链接是一个单独的文件，创建时它的引用计数值为 1；建立硬链接时，源文件引用计数值加 1。删除文件时，删除操作 对于符号链接是不可见的，这并不影响文件系统，当以后再通过符号链接访问时，发现文件不存在，直接删除符号链接；但对于硬链接则不可以直接删除，引用计数值减 1, 若值不为 0, 则不能删除此文件，因为还有其他硬链接指向此文件。当建立 F2 时，Fl 和 F2 的引用计数值都为 1。当再建立 F3 时，Fl 和 F3 的引用计数值就都变成了 2。当后来删除 Fl 时，F3 的引用计数值为 2-1 = 1, F2 的引用计数值 一直不变。', 9, 'Mogullzr', '2026-02-02 13:34:14', 9, NULL, '2026-02-02 13:34:14', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1118', '3330');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3331, '2009年408考研真题第32题', '简单', '2009年408真题', '程序员利用系统调用打开 I/O 设备时，通常使用的设备标识是（）。
', '[''逻辑设备名'', ''物理设备名'', ''主设备号'', ''从设备号'']', "['A']", 'A</font></strong>
设备管理具有设备独立性的特点，操作系统以系统调用方式来请求某类设备时，使用的是逻辑设备名。而在程序实际执行时，将逻辑设备名 转换为对应的物理设备名。', 9, 'Mogullzr', '2026-02-02 13:34:14', 9, NULL, '2026-02-02 13:34:14', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1119', '3331');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3332, '2009年408考研真题第33题', '简单', '2009年408真题', '在 OSI 参考模型中，自下而上第一个提供端到端服务的层次是（）。
', '[''数据链路层'', ''传输层'', ''会话层'', ''应用层'']', "['B']", 'B</font></strong>
传输层提供应用进程间的逻辑通信（通过端口号），即端到端的通信。而数据链路层负责相邻结点之间的通信，这个结点包括了交换机和路由器等数据通信 设备，这些设备 不能称为端系统。网络层负责主机到主机的逻辑通信。因此选 B。', 9, 'Mogullzr', '2026-02-02 13:34:14', 9, NULL, '2026-02-02 13:34:14', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1120', '3332');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3333, '2009年408考研真题第34题', '简单', '2009年408真题', '在无噪声情况下，若某低通通信链路的带宽为 3kHz，采用 4 个相位，每个相位具有 4 种振幅的 QAM 调制技术，则该通信链路的最大数据传输速率是（）。
', '[''12kbps'', ''24kbps'', ''48kbps'', ''96kbps'']', "['B']", 'B</font></strong>
采用 4 个相位，每个相位有 4 种幅度的 QAM 调制方法，每个信号可以有 16 种变化，传输 4bit 的数据。根据奈奎斯特定理，信息的最大传输速率为 2×3k×4=24kbps。', 9, 'Mogullzr', '2026-02-02 13:34:14', 9, NULL, '2026-02-02 13:34:14', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1121', '3333');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3334, '2009年408考研真题第35题', '简单', '2009年408真题', '数据链路层采用后退 N 帧（GBN）协议，发送方已经发送了编号为 0~7 的帧。当计时器超时时，若发送方只收到 0、2、3 号帧的确认，则发送方需要重发的帧数是（）。
', '[''2'', ''3'', ''4'', ''5'']', "['C']", 'C</font></strong>
...
7 的帧。', 9, 'Mogullzr', '2026-02-02 13:34:15', 9, NULL, '2026-02-02 13:34:15', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1122', '3334');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3335, '2009年408考研真题第36题', '简单', '2009年408真题', '以太网交换机进行转发决策时使用的 PDU 地址是（）。
', '[''目的物理地址'', ''目的 IP 地址'', ''源物理地址'', ''源 IP 地址'']', "['A']", 'A</font></strong>
交换机实质上是一个多端口网桥，工作在数据链路层，数据链路层 使用物理地址进行转发，而转发到目的地通常是使用 目的地址。因此 POU 地址是目的物理地址。', 9, 'Mogullzr', '2026-02-02 13:34:15', 9, NULL, '2026-02-02 13:34:15', 1, 1);
...
', '[''500'', ''700'', ''800'', ''1000'']', "['D']", 'D</font></strong>
返回的确认序列号是接收端期待收到对方下一个报文段数据部分的第一个字节的序号，因此乙在正确接收到两个段后，返回给甲的确认序列号是 200+ 300 + 500 = 1000。', 9, 'Mogullzr', '2026-02-02 13:34:15', 9, NULL, '2026-02-02 13:34:15', 1, 1);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1126', '3337');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3338, '2009年408考研真题第39题', '简单', '2009年408真题', '一个 TCP 连接总是以 1KB 的最大段长发送 TCP 段，发送方有足够多的数据要发送。当拥塞窗口为 16KB 时发生了超时，如果接下来的 4 个 RTT（往返时间）时间内的 TCP 段的传输都是成功的，那么当第 4 个 RTT 时间内发送的所有 TCP 段都得到肯定应答时，拥塞窗口大小是（）。
', '[''7 KB'', ''8 KB'', ''9 KB'', ''16 KB'']', "['C']", 'C</font></strong>
在发生超时后，慢开始门限 ssthresh 变为 16KB/2 = 8KB，拥塞窗口变为 1KB。在接下来的 3 个 RTT 内，执行慢开始算法，拥塞窗口大小依次为 2KB、4KB、8KB，由于慢开始门限 ssthresh 为 8KB，因此之后转而执行拥塞避免算法，即拥塞窗口开始“加法增大”。因此第 4 个 RTT 结束后，拥塞窗口的大小为 9KB。', 9, 'Mogullzr', '2026-02-02 13:34:15', 9, NULL, '2026-02-02 13:34:15', 1, 1);
...
', '[''建立在 TCP 之上的控制连接'', ''建立在 TCP 之上的数据连接'', ''建立在 UDP 之上的控制连接'', ''建立在 UDP 之上的数据连接'']', "['A']", 'A</font></strong>
对于FTP文件传输，为了保证可靠性，选择 TCP 协议，排除 C、D。FTP 的控制信息是带外传送的，也即 FTP 使用了一个分离的控制连接来传送命令，故选 A。', 9, 'Mogullzr', '2026-02-02 13:34:15', 9, NULL, '2026-02-02 13:34:15', 1, 1);
...
', 9, 'Mogullzr', '2026-02-02 13:34:15', 9, NULL, '2026-02-02 13:34:15', 1, 0);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1129', '3340');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3341, '2009年408考研真题第42题', '简单', '2009年408真题', '已知一个带有表头结点的单链表，结点结构为：`| data | link |`
...
- 若 p 为空，转 5；
- 若 count 等于 k，则 q 指向下一个结点；否则，count=count+l;
- p 指向下一个结点，转 2：
...
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3342, '2009年408考研真题第43题', '简单', '2009年408真题', '某计算机的 CPU 主频为 500MHz，CPI 为 5（即执行每条指令平均需 5 个时钟周期）。假定某外设的数据传输率为 0.5MB/s，采用中断方式与主机进行数据传送，以 32 位为传输单位，对应的中断服务程序包含 18 条指令，中断服务的其他开销相当于 2 条指令的执行时间。请回答下列问题，要求给出计算过程。
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/0a195f508d8b45fd9dbb8d51ac7e5925.svg)
...
', 9, 'Mogullzr', '2026-02-02 13:34:17', 9, NULL, '2026-02-02 13:34:17', 1, 0);
INSERT INTO byteoj.problem_math408_tags (tag_id, problem_id)VALUES ('1134', '3343');
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3344, '2009年408考研真题第45题', '简单', '2009年408真题', '三个进程$P_{1}$、$P_{2}$、$P_{3}$互斥使用一个包含$N(N > 0)$个单元的缓冲区。$P_{1}$每次用`produce()`生成一个正整数并用`put()`送入缓冲区某一空单元中；$P_{2}$每次用`getodd()`从该缓冲区中取出一个奇数并用`countodd()`统计奇数个数；$P_{3}$每次用`geteven()`从该缓冲区中取出一个偶数并用`counteven()`统计偶数个数。请用信号量机制实现这三个进程的同步与互斥活动，并说明所定义信号量的含义。要求用伪代码描述。
...
INSERT INTO byteoj.problem_math408_bank (problem_id, problem_name, difficulty_name, source_name, description, options, correct_answer, analysis, create_by_id, create_by_name, create_time, update_by_id, update_by_name, update_time, status, option_type) VALUES (3345, '2009年408考研真题第46题', '简单', '2009年408真题', '请求分页管理系统中，假设某进程的页表内容如下表所示：
...
![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/21ddfdc773274c0b931f3b6f7f297273.svg)

R1 和 R2 的路由表结构为：

![图片](http://mogullzr001.oss-cn-beijing.aliyuncs.com/2026/02/59dc834db313423fa1f0f49e50c1bc26.svg)
...
', 9, 'Mogullzr', '2026-02-02 13:34:20', 9, NULL, '2026-02-02 13:34:20', 1, 0);
