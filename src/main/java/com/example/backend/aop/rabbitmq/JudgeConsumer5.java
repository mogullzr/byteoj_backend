...
public class JudgeConsumer5 {
    private static final Logger log = LoggerFactory.getLogger(JudgeConsumer5.class);

    private static final int SANDBOX_INDEX = 5;
    private static final String SANDBOX_URL = RabbitMQConfig.SANDBOX_URLS[5];
