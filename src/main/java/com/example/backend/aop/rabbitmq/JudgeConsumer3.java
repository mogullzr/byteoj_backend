 ...
 */
@Component
@RabbitListener(queues = "judge.submit.queue.3", containerFactory = "rabbitListenerContainerFactory")
public class JudgeConsumer3 {
    private static final Logger log = LoggerFactory.getLogger(JudgeConsumer3.class);

    private static final int SANDBOX_INDEX = 3;
    private static final String SANDBOX_URL = RabbitMQConfig.SANDBOX_URLS[3];
