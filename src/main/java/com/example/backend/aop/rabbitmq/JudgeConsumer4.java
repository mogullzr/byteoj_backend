 ...
 */
@Component
@RabbitListener(queues = "judge.submit.queue.4", containerFactory = "rabbitListenerContainerFactory")
public class JudgeConsumer4 {
    private static final Logger log = LoggerFactory.getLogger(JudgeConsumer4.class);

    private static final int SANDBOX_INDEX = 4;
    private static final String SANDBOX_URL = RabbitMQConfig.SANDBOX_URLS[4];
