 ...
 */
@Component
@RabbitListener(queues = "judge.submit.queue.2", containerFactory = "rabbitListenerContainerFactory")
public class JudgeConsumer2 {
    private static final Logger log = LoggerFactory.getLogger(JudgeConsumer2.class);

    private static final int SANDBOX_INDEX = 2;
    private static final String SANDBOX_URL = RabbitMQConfig.SANDBOX_URLS[2];
