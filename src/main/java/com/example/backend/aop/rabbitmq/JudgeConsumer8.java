 ...
 */
@Component
@RabbitListener(queues = "judge.submit.queue.8", containerFactory = "rabbitListenerContainerFactory")
public class JudgeConsumer8 {
    private static final Logger log = LoggerFactory.getLogger(JudgeConsumer8.class);

    private static final int SANDBOX_INDEX = 8;
    private static final String SANDBOX_URL = RabbitMQConfig.SANDBOX_URLS[8];
