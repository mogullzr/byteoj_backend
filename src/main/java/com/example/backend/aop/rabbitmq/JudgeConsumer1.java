 ...
 */
@Component
@RabbitListener(queues = "judge.submit.queue.1", containerFactory = "rabbitListenerContainerFactory")
public class JudgeConsumer1 {
    private static final Logger log = LoggerFactory.getLogger(JudgeConsumer1.class);

    private static final int SANDBOX_INDEX = 1;
    private static final String SANDBOX_URL = RabbitMQConfig.SANDBOX_URLS[1];
