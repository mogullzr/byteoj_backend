 ...
 */
@Component
@RabbitListener(queues = "judge.submit.queue.6", containerFactory = "rabbitListenerContainerFactory")
public class JudgeConsumer6 {
    private static final Logger log = LoggerFactory.getLogger(JudgeConsumer6.class);

    private static final int SANDBOX_INDEX = 6;
    private static final String SANDBOX_URL = RabbitMQConfig.SANDBOX_URLS[6];
