 ...
 */
@Component
@RabbitListener(queues = "judge.submit.queue.9", containerFactory = "rabbitListenerContainerFactory")
public class JudgeConsumer9 {
    private static final Logger log = LoggerFactory.getLogger(JudgeConsumer9.class);

    private static final int SANDBOX_INDEX = 9;
    private static final String SANDBOX_URL = RabbitMQConfig.SANDBOX_URLS[9];
